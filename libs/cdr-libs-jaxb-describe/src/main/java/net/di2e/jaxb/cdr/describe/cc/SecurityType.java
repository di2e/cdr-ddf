...
public class SecurityType implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        {
            List<String> theDisseminationControls;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final SecurityType that = ((SecurityType) object);
        {
            long lhsCount;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof SecurityType) {
            final SecurityType copy = ((SecurityType) draftCopy);
            {
            ...
            }
            {
                ...
                if (disseminationControlsShouldBeCopiedAndSet == Boolean.TRUE) {
                    List<String> sourceDisseminationControls;
                    sourceDisseminationControls = (this.isSetDisseminationControls()?this.getDisseminationControls():null);
                    @SuppressWarnings("unchecked")
                    List<String> copyDisseminationControls = ((List<String> ) strategy.copy(LocatorUtils.property(locator, "disseminationControls", sourceDisseminationControls), sourceDisseminationControls, this.isSetDisseminationControls()));
                    copy.unsetDisseminationControls();
                    if (copyDisseminationControls!= null) {
                        List<String> uniqueDisseminationControlsl = copy.getDisseminationControls();
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof SecurityType) {
            final SecurityType target = this;
            final SecurityType leftObject = ((SecurityType) left);
            final SecurityType rightObject = ((SecurityType) right);
            {
    ...
    public void setDisseminationControls(List<String> value) {
        this.disseminationControls = null;
        if (value!= null) {
            List<String> draftl = this.getDisseminationControls();
            draftl.addAll(value);
        }
    }
