 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:cdr-ex:describe:cc:1.0}metrics"/&gt;
 *         &lt;element ref="{urn:cdr-ex:describe:cc:1.0}originator"/&gt;
 *         &lt;element ref="{urn:cdr-ex:describe:cc:1.0}mimeTypes" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:cdr-ex:describe:cc:1.0}securityCoverage" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:cdr-ex:describe:cc:1.0}searchableFields" minOccurs="0"/&gt;
...
public class ContentCollectionType implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{

    private final static long serialVersionUID = 1L;
    @XmlElement(required = true)
    @NotNull(message = "ContentCollectionType.metrics {javax.validation.constraints.NotNull.message}")
    @Valid
    protected MetricsType metrics;
    @XmlElement(required = true)
    @XmlSchemaType(name = "anySimpleType")
    @NotNull(message = "ContentCollectionType.originator {javax.validation.constraints.NotNull.message}")
    protected String originator;
    @Valid
    protected MimeTypes mimeTypes;
    @Valid
    protected SecurityCoverage securityCoverage;
    @Valid
    protected SearchableFields searchableFields;
    @XmlAnyElement(lax = true)
    protected List<Object> any;
    @XmlAttribute(name = "updated", required = true)
    @XmlSchemaType(name = "dateTime")
    @NotNull(message = "ContentCollectionType.updated {javax.validation.constraints.NotNull.message}")
    protected XMLGregorianCalendar updated;
    @XmlAttribute(name = "classification", namespace = "urn:us:gov:ic:ism", required = true)
    @NotNull(message = "ContentCollectionType.classification {javax.validation.constraints.NotNull.message}")
    ...
    @NotNull(message = "ContentCollectionType.ownerProducer {javax.validation.constraints.NotNull.message}")
     ...
     * @return
     *     possible object is
     *     {@link SecurityCoverage }
     *     
     */
    public SecurityCoverage getSecurityCoverage() {
     ...
     *     
     */
    public void setSecurityCoverage(SecurityCoverage value) {
        this.securityCoverage = value;
    }

    public boolean isSetSecurityCoverage() {
        return (this.securityCoverage!= null);
    }

    /**
     * Gets the value of the searchableFields property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public SearchableFields getSearchableFields() {
        return searchableFields;
    }

    /**
     * Sets the value of the searchableFields property.
     * 
     * @param value
     *     allowed object is
     *     {@link SearchableFields }
     *     
     */
    public void setSearchableFields(SearchableFields value) {
        this.searchableFields = value;
    }

    public boolean isSetSearchableFields() {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            MetricsType theMetrics;
            theMetrics = this.getMetrics();
            strategy.appendField(locator, this, "metrics", buffer, theMetrics, this.isSetMetrics());
        }
        {
        ...
        {
            MimeTypes theMimeTypes;
            theMimeTypes = this.getMimeTypes();
            strategy.appendField(locator, this, "mimeTypes", buffer, theMimeTypes, this.isSetMimeTypes());
        }
        {
            SecurityCoverage theSecurityCoverage;
            theSecurityCoverage = this.getSecurityCoverage();
            strategy.appendField(locator, this, "securityCoverage", buffer, theSecurityCoverage, this.isSetSecurityCoverage());
        }
        {
            SearchableFields theSearchableFields;
            theSearchableFields = this.getSearchableFields();
            strategy.appendField(locator, this, "searchableFields", buffer, theSearchableFields, this.isSetSearchableFields());
        }
        {
            List<Object> theAny;
        ...
        }
        {
            ...
            strategy.appendField(locator, this, "updated", buffer, theUpdated, this.isSetUpdated());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ContentCollectionType that = ((ContentCollectionType) object);
        {
            MetricsType lhsMetrics;
            lhsMetrics = this.getMetrics();
            MetricsType rhsMetrics;
            rhsMetrics = that.getMetrics();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "metrics", lhsMetrics), LocatorUtils.property(thatLocator, "metrics", rhsMetrics), lhsMetrics, rhsMetrics, this.isSetMetrics(), that.isSetMetrics())) {
                return false;
            }
        }
        {
            String lhsOriginator;
            lhsOriginator = this.getOriginator();
            String rhsOriginator;
        ...
        {
            MimeTypes lhsMimeTypes;
            lhsMimeTypes = this.getMimeTypes();
            MimeTypes rhsMimeTypes;
            rhsMimeTypes = that.getMimeTypes();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "mimeTypes", lhsMimeTypes), LocatorUtils.property(thatLocator, "mimeTypes", rhsMimeTypes), lhsMimeTypes, rhsMimeTypes, this.isSetMimeTypes(), that.isSetMimeTypes())) {
                return false;
            }
        }
        {
            SecurityCoverage lhsSecurityCoverage;
            lhsSecurityCoverage = this.getSecurityCoverage();
            SecurityCoverage rhsSecurityCoverage;
            rhsSecurityCoverage = that.getSecurityCoverage();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "securityCoverage", lhsSecurityCoverage), LocatorUtils.property(thatLocator, "securityCoverage", rhsSecurityCoverage), lhsSecurityCoverage, rhsSecurityCoverage, this.isSetSecurityCoverage(), that.isSetSecurityCoverage())) {
                return false;
            }
        }
        {
            SearchableFields lhsSearchableFields;
            lhsSearchableFields = this.getSearchableFields();
            SearchableFields rhsSearchableFields;
            rhsSearchableFields = that.getSearchableFields();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "searchableFields", lhsSearchableFields), LocatorUtils.property(thatLocator, "searchableFields", rhsSearchableFields), lhsSearchableFields, rhsSearchableFields, this.isSetSearchableFields(), that.isSetSearchableFields())) {
                return false;
            }
        }
        {
        ...
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "updated", lhsUpdated), LocatorUtils.property(thatLocator, "updated", rhsUpdated), lhsUpdated, rhsUpdated, this.isSetUpdated(), that.isSetUpdated())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            MetricsType theMetrics;
            theMetrics = this.getMetrics();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "metrics", theMetrics), currentHashCode, theMetrics, this.isSetMetrics());
        }
        {
            String theOriginator;
            theOriginator = this.getOriginator();
        ...
        }
        {
            MimeTypes theMimeTypes;
            theMimeTypes = this.getMimeTypes();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "mimeTypes", theMimeTypes), currentHashCode, theMimeTypes, this.isSetMimeTypes());
        }
        {
            SecurityCoverage theSecurityCoverage;
            theSecurityCoverage = this.getSecurityCoverage();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "securityCoverage", theSecurityCoverage), currentHashCode, theSecurityCoverage, this.isSetSecurityCoverage());
        }
        {
            SearchableFields theSearchableFields;
            theSearchableFields = this.getSearchableFields();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "searchableFields", theSearchableFields), currentHashCode, theSearchableFields, this.isSetSearchableFields());
        }
        {
            List<Object> theAny;
            theAny = (this.isSetAny()?this.getAny():null);
        ...
        }
        {
            XMLGregorianCalendar theUpdated;
            theUpdated = this.getUpdated();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "updated", theUpdated), currentHashCode, theUpdated, this.isSetUpdated());
        }
        {
            CVEnumISMClassificationAll theClassification;
            theClassification = this.getClassification();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof ContentCollectionType) {
            final ContentCollectionType copy = ((ContentCollectionType) draftCopy);
            {
                Boolean metricsShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMetrics());
                if (metricsShouldBeCopiedAndSet == Boolean.TRUE) {
                    MetricsType sourceMetrics;
                    sourceMetrics = this.getMetrics();
                    MetricsType copyMetrics = ((MetricsType) strategy.copy(LocatorUtils.property(locator, "metrics", sourceMetrics), sourceMetrics, this.isSetMetrics()));
                    copy.setMetrics(copyMetrics);
                } else {
                    if (metricsShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.metrics = null;
                    }
                }
            }
            {
                ...
                if (originatorShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    String copyOriginator = ((String) strategy.copy(LocatorUtils.property(locator, "originator", sourceOriginator), sourceOriginator, this.isSetOriginator()));
            ...
            {
                Boolean mimeTypesShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetMimeTypes());
                if (mimeTypesShouldBeCopiedAndSet == Boolean.TRUE) {
                    MimeTypes sourceMimeTypes;
                    sourceMimeTypes = this.getMimeTypes();
                    MimeTypes copyMimeTypes = ((MimeTypes) strategy.copy(LocatorUtils.property(locator, "mimeTypes", sourceMimeTypes), sourceMimeTypes, this.isSetMimeTypes()));
                    copy.setMimeTypes(copyMimeTypes);
                } else {
                    if (mimeTypesShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.mimeTypes = null;
                    }
                }
            }
            {
                Boolean securityCoverageShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetSecurityCoverage());
                if (securityCoverageShouldBeCopiedAndSet == Boolean.TRUE) {
                    SecurityCoverage sourceSecurityCoverage;
                    sourceSecurityCoverage = this.getSecurityCoverage();
                    SecurityCoverage copySecurityCoverage = ((SecurityCoverage) strategy.copy(LocatorUtils.property(locator, "securityCoverage", sourceSecurityCoverage), sourceSecurityCoverage, this.isSetSecurityCoverage()));
                    copy.setSecurityCoverage(copySecurityCoverage);
                } else {
                    if (securityCoverageShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.securityCoverage = null;
                    }
                }
            }
            {
                Boolean searchableFieldsShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetSearchableFields());
                if (searchableFieldsShouldBeCopiedAndSet == Boolean.TRUE) {
                    SearchableFields sourceSearchableFields;
                    sourceSearchableFields = this.getSearchableFields();
                    SearchableFields copySearchableFields = ((SearchableFields) strategy.copy(LocatorUtils.property(locator, "searchableFields", sourceSearchableFields), sourceSearchableFields, this.isSetSearchableFields()));
                    copy.setSearchableFields(copySearchableFields);
                } else {
                    if (searchableFieldsShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.searchableFields = null;
                    }
                }
            }
            {
            ...
            {
                Boolean updatedShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetUpdated());
                if (updatedShouldBeCopiedAndSet == Boolean.TRUE) {
                    XMLGregorianCalendar sourceUpdated;
                    sourceUpdated = this.getUpdated();
                    XMLGregorianCalendar copyUpdated = ((XMLGregorianCalendar) strategy.copy(LocatorUtils.property(locator, "updated", sourceUpdated), sourceUpdated, this.isSetUpdated()));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof ContentCollectionType) {
            final ContentCollectionType target = this;
            final ContentCollectionType leftObject = ((ContentCollectionType) left);
            final ContentCollectionType rightObject = ((ContentCollectionType) right);
            {
                Boolean metricsShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMetrics(), rightObject.isSetMetrics());
                if (metricsShouldBeMergedAndSet == Boolean.TRUE) {
                    MetricsType lhsMetrics;
                    lhsMetrics = leftObject.getMetrics();
                    MetricsType rhsMetrics;
                    rhsMetrics = rightObject.getMetrics();
                    MetricsType mergedMetrics = ((MetricsType) strategy.merge(LocatorUtils.property(leftLocator, "metrics", lhsMetrics), LocatorUtils.property(rightLocator, "metrics", rhsMetrics), lhsMetrics, rhsMetrics, leftObject.isSetMetrics(), rightObject.isSetMetrics()));
                    target.setMetrics(mergedMetrics);
                } else {
                    if (metricsShouldBeMergedAndSet == Boolean.FALSE) {
                        target.metrics = null;
                    }
                }
            }
            {
                Boolean originatorShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetOriginator(), rightObject.isSetOriginator());
                if (originatorShouldBeMergedAndSet == Boolean.TRUE) {
                    String lhsOriginator;
                    lhsOriginator = leftObject.getOriginator();
                    String rhsOriginator;
                    rhsOriginator = rightObject.getOriginator();
                    String mergedOriginator = ((String) strategy.merge(LocatorUtils.property(leftLocator, "originator", lhsOriginator), LocatorUtils.property(rightLocator, "originator", rhsOriginator), lhsOriginator, rhsOriginator, leftObject.isSetOriginator(), rightObject.isSetOriginator()));
                    target.setOriginator(mergedOriginator);
                } else {
                    if (originatorShouldBeMergedAndSet == Boolean.FALSE) {
                        target.originator = null;
                    }
                }
            }
            {
                Boolean mimeTypesShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetMimeTypes(), rightObject.isSetMimeTypes());
                if (mimeTypesShouldBeMergedAndSet == Boolean.TRUE) {
                    MimeTypes lhsMimeTypes;
                    lhsMimeTypes = leftObject.getMimeTypes();
                    MimeTypes rhsMimeTypes;
                    rhsMimeTypes = rightObject.getMimeTypes();
                    MimeTypes mergedMimeTypes = ((MimeTypes) strategy.merge(LocatorUtils.property(leftLocator, "mimeTypes", lhsMimeTypes), LocatorUtils.property(rightLocator, "mimeTypes", rhsMimeTypes), lhsMimeTypes, rhsMimeTypes, leftObject.isSetMimeTypes(), rightObject.isSetMimeTypes()));
                    target.setMimeTypes(mergedMimeTypes);
                } else {
                    if (mimeTypesShouldBeMergedAndSet == Boolean.FALSE) {
                        target.mimeTypes = null;
                    }
                }
            }
            {
                Boolean securityCoverageShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetSecurityCoverage(), rightObject.isSetSecurityCoverage());
                if (securityCoverageShouldBeMergedAndSet == Boolean.TRUE) {
                    SecurityCoverage lhsSecurityCoverage;
                    lhsSecurityCoverage = leftObject.getSecurityCoverage();
                    SecurityCoverage rhsSecurityCoverage;
                    rhsSecurityCoverage = rightObject.getSecurityCoverage();
                    SecurityCoverage mergedSecurityCoverage = ((SecurityCoverage) strategy.merge(LocatorUtils.property(leftLocator, "securityCoverage", lhsSecurityCoverage), LocatorUtils.property(rightLocator, "securityCoverage", rhsSecurityCoverage), lhsSecurityCoverage, rhsSecurityCoverage, leftObject.isSetSecurityCoverage(), rightObject.isSetSecurityCoverage()));
                    target.setSecurityCoverage(mergedSecurityCoverage);
                } else {
                    if (securityCoverageShouldBeMergedAndSet == Boolean.FALSE) {
                        target.securityCoverage = null;
                    }
                }
            }
            {
                Boolean searchableFieldsShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetSearchableFields(), rightObject.isSetSearchableFields());
                if (searchableFieldsShouldBeMergedAndSet == Boolean.TRUE) {
                    SearchableFields lhsSearchableFields;
                    lhsSearchableFields = leftObject.getSearchableFields();
                    SearchableFields rhsSearchableFields;
                    rhsSearchableFields = rightObject.getSearchableFields();
                    SearchableFields mergedSearchableFields = ((SearchableFields) strategy.merge(LocatorUtils.property(leftLocator, "searchableFields", lhsSearchableFields), LocatorUtils.property(rightLocator, "searchableFields", rhsSearchableFields), lhsSearchableFields, rhsSearchableFields, leftObject.isSetSearchableFields(), rightObject.isSetSearchableFields()));
                    target.setSearchableFields(mergedSearchableFields);
                } else {
                    if (searchableFieldsShouldBeMergedAndSet == Boolean.FALSE) {
                        target.searchableFields = null;
                    }
                }
            }
            {
            ...
            {
                Boolean updatedShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetUpdated(), rightObject.isSetUpdated());
                if (updatedShouldBeMergedAndSet == Boolean.TRUE) {
                    XMLGregorianCalendar lhsUpdated;
                    lhsUpdated = leftObject.getUpdated();
                    XMLGregorianCalendar rhsUpdated;
                    rhsUpdated = rightObject.getUpdated();
                    XMLGregorianCalendar mergedUpdated = ((XMLGregorianCalendar) strategy.merge(LocatorUtils.property(leftLocator, "updated", lhsUpdated), LocatorUtils.property(rightLocator, "updated", rhsUpdated), lhsUpdated, rhsUpdated, leftObject.isSetUpdated(), rightObject.isSetUpdated()));
