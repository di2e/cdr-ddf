...
public class NameType implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    @NotNull(message = "NameType.classification {javax.validation.constraints.NotNull.message}")
    ...
    @NotNull(message = "NameType.ownerProducer {javax.validation.constraints.NotNull.message}")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final NameType that = ((NameType) object);
        {
            String lhsValue;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof NameType) {
            final NameType copy = ((NameType) draftCopy);
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof NameType) {
            final NameType target = this;
            final NameType leftObject = ((NameType) left);
            final NameType rightObject = ((NameType) right);
            {
