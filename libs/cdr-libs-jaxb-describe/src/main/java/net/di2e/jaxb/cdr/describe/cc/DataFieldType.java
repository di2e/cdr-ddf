 ...
 *       &lt;attribute name="id" type="{urn:cdr-ex:describe:cc:1.0}SimpleTokenType" /&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
@XmlType(name = "DataFieldType")
public class DataFieldType implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final DataFieldType that = ((DataFieldType) object);
        {
            String lhsId;
            lhsId = this.getId();
            String rhsId;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof DataFieldType) {
            final DataFieldType copy = ((DataFieldType) draftCopy);
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof DataFieldType) {
            final DataFieldType target = this;
            final DataFieldType leftObject = ((DataFieldType) left);
            final DataFieldType rightObject = ((DataFieldType) right);
            {
