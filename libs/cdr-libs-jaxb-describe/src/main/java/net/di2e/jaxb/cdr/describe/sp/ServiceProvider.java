 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:cdr-ex:describe:sp:1.0}generalInfo"/&gt;
 *         &lt;element ref="{urn:cdr-ex:describe:sp:1.0}service" maxOccurs="100"/&gt;
 *         &lt;element ref="{urn:cdr-ex:describe:sp:1.0}extension" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class ServiceProvider implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{

    private final static long serialVersionUID = 1L;
    @XmlElement(required = true)
    @NotNull(message = "ServiceProvider.generalInfo {javax.validation.constraints.NotNull.message}")
    @Valid
    protected GeneralInfoType generalInfo;
    @XmlElement(required = true)
    @NotNull(message = "ServiceProvider.service {javax.validation.constraints.NotNull.message}")
    @Size(min = 1, max = 100)
    @Valid
    ...
    @NotNull(message = "ServiceProvider.updated {javax.validation.constraints.NotNull.message}")
    protected XMLGregorianCalendar updated;
    @XmlAttribute(name = "classification", namespace = "urn:us:gov:ic:ism", required = true)
    @NotNull(message = "ServiceProvider.classification {javax.validation.constraints.NotNull.message}")
    ...
    @NotNull(message = "ServiceProvider.ownerProducer {javax.validation.constraints.NotNull.message}")
    ...
    public boolean isSetGeneralInfo() {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            GeneralInfoType theGeneralInfo;
            theGeneralInfo = this.getGeneralInfo();
            strategy.appendField(locator, this, "generalInfo", buffer, theGeneralInfo, this.isSetGeneralInfo());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            GeneralInfoType lhsGeneralInfo;
            lhsGeneralInfo = this.getGeneralInfo();
            GeneralInfoType rhsGeneralInfo;
            rhsGeneralInfo = that.getGeneralInfo();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "generalInfo", lhsGeneralInfo), LocatorUtils.property(thatLocator, "generalInfo", rhsGeneralInfo), lhsGeneralInfo, rhsGeneralInfo, this.isSetGeneralInfo(), that.isSetGeneralInfo())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            GeneralInfoType theGeneralInfo;
            theGeneralInfo = this.getGeneralInfo();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "generalInfo", theGeneralInfo), currentHashCode, theGeneralInfo, this.isSetGeneralInfo());
        }
        {
            List<ServiceType> theService;
            theService = (this.isSetService()?this.getService():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof ServiceProvider) {
            ...
            {
                Boolean generalInfoShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetGeneralInfo());
                if (generalInfoShouldBeCopiedAndSet == Boolean.TRUE) {
                    GeneralInfoType sourceGeneralInfo;
                    sourceGeneralInfo = this.getGeneralInfo();
                    GeneralInfoType copyGeneralInfo = ((GeneralInfoType) strategy.copy(LocatorUtils.property(locator, "generalInfo", sourceGeneralInfo), sourceGeneralInfo, this.isSetGeneralInfo()));
                    copy.setGeneralInfo(copyGeneralInfo);
                } else {
                    if (generalInfoShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.generalInfo = null;
                    }
                }
            }
            {
                ...
                if (serviceShouldBeCopiedAndSet == Boolean.TRUE) {
                    List<ServiceType> sourceService;
                    sourceService = (this.isSetService()?this.getService():null);
                    @SuppressWarnings("unchecked")
                    List<ServiceType> copyService = ((List<ServiceType> ) strategy.copy(LocatorUtils.property(locator, "service", sourceService), sourceService, this.isSetService()));
                    copy.unsetService();
                    if (copyService!= null) {
                        List<ServiceType> uniqueServicel = copy.getService();
            ...
            }
            {
                ...
                if (extensionShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    ExtensionType copyExtension = ((ExtensionType) strategy.copy(LocatorUtils.property(locator, "extension", sourceExtension), sourceExtension, this.isSetExtension()));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof ServiceProvider) {
            ...
            {
                Boolean generalInfoShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetGeneralInfo(), rightObject.isSetGeneralInfo());
                if (generalInfoShouldBeMergedAndSet == Boolean.TRUE) {
                    GeneralInfoType lhsGeneralInfo;
                    lhsGeneralInfo = leftObject.getGeneralInfo();
                    GeneralInfoType rhsGeneralInfo;
                    rhsGeneralInfo = rightObject.getGeneralInfo();
                    GeneralInfoType mergedGeneralInfo = ((GeneralInfoType) strategy.merge(LocatorUtils.property(leftLocator, "generalInfo", lhsGeneralInfo), LocatorUtils.property(rightLocator, "generalInfo", rhsGeneralInfo), lhsGeneralInfo, rhsGeneralInfo, leftObject.isSetGeneralInfo(), rightObject.isSetGeneralInfo()));
                    target.setGeneralInfo(mergedGeneralInfo);
                } else {
                    if (generalInfoShouldBeMergedAndSet == Boolean.FALSE) {
                        target.generalInfo = null;
                    }
                }
            }
            {
                ...
                if (serviceShouldBeMergedAndSet == Boolean.TRUE) {
                    List<ServiceType> lhsService;
                    lhsService = (leftObject.isSetService()?leftObject.getService():null);
                    List<ServiceType> rhsService;
                    rhsService = (rightObject.isSetService()?rightObject.getService():null);
                    List<ServiceType> mergedService = ((List<ServiceType> ) strategy.merge(LocatorUtils.property(leftLocator, "service", lhsService), LocatorUtils.property(rightLocator, "service", rhsService), lhsService, rhsService, leftObject.isSetService(), rightObject.isSetService()));
                    target.unsetService();
                    if (mergedService!= null) {
                        List<ServiceType> uniqueServicel = target.getService();
                        uniqueServicel.addAll(mergedService);
                    }
                } else {
            ...
            }
            {
                ...
                if (extensionShouldBeMergedAndSet == Boolean.TRUE) {
                    ExtensionType lhsExtension;
                    lhsExtension = leftObject.getExtension();
                    ExtensionType rhsExtension;
                    rhsExtension = rightObject.getExtension();
                    ExtensionType mergedExtension = ((ExtensionType) strategy.merge(LocatorUtils.property(leftLocator, "extension", lhsExtension), LocatorUtils.property(rightLocator, "extension", rhsExtension), lhsExtension, rhsExtension, leftObject.isSetExtension(), rightObject.isSetExtension()));
                    target.setExtension(mergedExtension);
                } else {
    ...
    public void setService(List<ServiceType> value) {
        this.service = null;
        if (value!= null) {
            List<ServiceType> draftl = this.getService();
            draftl.addAll(value);
        }
    }
