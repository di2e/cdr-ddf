 ...
 *         &lt;element ref="{http://www.opengis.net/gml/3.3/ce}SimpleMultiPoint"/&gt;
 *       &lt;/choice&gt;
...
public class MultiPointPropertyType implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{

    private final static long serialVersionUID = 1L;
    @XmlElement(name = "MultiPoint", namespace = "http://www.opengis.net/gml/3.2")
    @Valid
    protected MultiPointType multiPoint;
    @XmlElement(name = "SimpleMultiPoint")
    @Valid
    protected SimpleMultiPointType simpleMultiPoint;
     ...
     * @return
     *     possible object is
     *     {@link SimpleMultiPointType }
     *     
     */
    public SimpleMultiPointType getSimpleMultiPoint() {
        return simpleMultiPoint;
    }
     ...
     *     
     */
    public void setSimpleMultiPoint(SimpleMultiPointType value) {
        this.simpleMultiPoint = value;
    }

    public boolean isSetSimpleMultiPoint() {
        return (this.simpleMultiPoint!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        {
            SimpleMultiPointType theSimpleMultiPoint;
            theSimpleMultiPoint = this.getSimpleMultiPoint();
            strategy.appendField(locator, this, "simpleMultiPoint", buffer, theSimpleMultiPoint, this.isSetSimpleMultiPoint());
        }
        {
        ...
        {
            boolean theOwns;
            theOwns = (this.isSetOwns()?this.getOwns():false);
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            SimpleMultiPointType lhsSimpleMultiPoint;
            lhsSimpleMultiPoint = this.getSimpleMultiPoint();
            SimpleMultiPointType rhsSimpleMultiPoint;
            rhsSimpleMultiPoint = that.getSimpleMultiPoint();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "simpleMultiPoint", lhsSimpleMultiPoint), LocatorUtils.property(thatLocator, "simpleMultiPoint", rhsSimpleMultiPoint), lhsSimpleMultiPoint, rhsSimpleMultiPoint, this.isSetSimpleMultiPoint(), that.isSetSimpleMultiPoint())) {
                return false;
            }
        }
        {
        ...
        {
            boolean lhsOwns;
            lhsOwns = (this.isSetOwns()?this.getOwns():false);
            boolean rhsOwns;
            rhsOwns = (that.isSetOwns()?that.getOwns():false);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        }
        {
            SimpleMultiPointType theSimpleMultiPoint;
            theSimpleMultiPoint = this.getSimpleMultiPoint();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "simpleMultiPoint", theSimpleMultiPoint), currentHashCode, theSimpleMultiPoint, this.isSetSimpleMultiPoint());
        }
        {
            List<String> theNilReason;
            theNilReason = (this.isSetNilReason()?this.getNilReason():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof MultiPointPropertyType) {
            ...
            {
                Boolean simpleMultiPointShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetSimpleMultiPoint());
                if (simpleMultiPointShouldBeCopiedAndSet == Boolean.TRUE) {
                    SimpleMultiPointType sourceSimpleMultiPoint;
                    sourceSimpleMultiPoint = this.getSimpleMultiPoint();
                    SimpleMultiPointType copySimpleMultiPoint = ((SimpleMultiPointType) strategy.copy(LocatorUtils.property(locator, "simpleMultiPoint", sourceSimpleMultiPoint), sourceSimpleMultiPoint, this.isSetSimpleMultiPoint()));
                    copy.setSimpleMultiPoint(copySimpleMultiPoint);
                } else {
                    if (simpleMultiPointShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.simpleMultiPoint = null;
                    }
                }
            }
            {
            ...
            }
            {
                ...
                if (ownsShouldBeCopiedAndSet == Boolean.TRUE) {
                    boolean sourceOwns;
                    sourceOwns = (this.isSetOwns()?this.getOwns():false);
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof MultiPointPropertyType) {
            ...
            {
                Boolean simpleMultiPointShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetSimpleMultiPoint(), rightObject.isSetSimpleMultiPoint());
                if (simpleMultiPointShouldBeMergedAndSet == Boolean.TRUE) {
                    SimpleMultiPointType lhsSimpleMultiPoint;
                    lhsSimpleMultiPoint = leftObject.getSimpleMultiPoint();
                    SimpleMultiPointType rhsSimpleMultiPoint;
                    rhsSimpleMultiPoint = rightObject.getSimpleMultiPoint();
                    SimpleMultiPointType mergedSimpleMultiPoint = ((SimpleMultiPointType) strategy.merge(LocatorUtils.property(leftLocator, "simpleMultiPoint", lhsSimpleMultiPoint), LocatorUtils.property(rightLocator, "simpleMultiPoint", rhsSimpleMultiPoint), lhsSimpleMultiPoint, rhsSimpleMultiPoint, leftObject.isSetSimpleMultiPoint(), rightObject.isSetSimpleMultiPoint()));
                    target.setSimpleMultiPoint(mergedSimpleMultiPoint);
                } else {
                    if (simpleMultiPointShouldBeMergedAndSet == Boolean.FALSE) {
                        target.simpleMultiPoint = null;
                    }
                }
            }
            {
            ...
            }
            {
                ...
                if (ownsShouldBeMergedAndSet == Boolean.TRUE) {
                    boolean lhsOwns;
                    lhsOwns = (leftObject.isSetOwns()?leftObject.getOwns():false);
                    boolean rhsOwns;
                    rhsOwns = (rightObject.isSetOwns()?rightObject.getOwns():false);
