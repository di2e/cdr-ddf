...
/**
 * <p>Java class for SimpleArcByBulgeType complex type.
 * 
...
@XmlType(name = "SimpleArcByBulgeType", propOrder = {
    "posOrPointProperty",
    "posList",
    "bulge",
    "normal"
})
public class SimpleArcByBulgeType
    ...
    implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    @NotNull(message = "SimpleArcByBulgeType.bulge {javax.validation.constraints.NotNull.message}")
    @Size(min = 1)
    protected List<Double> bulge;
    @XmlElement(required = true)
    @NotNull(message = "SimpleArcByBulgeType.normal {javax.validation.constraints.NotNull.message}")
    @Size(min = 1)
    @Valid
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final SimpleArcByBulgeType that = ((SimpleArcByBulgeType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof SimpleArcByBulgeType) {
            final SimpleArcByBulgeType copy = ((SimpleArcByBulgeType) draftCopy);
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        ...
        if (right instanceof SimpleArcByBulgeType) {
            final SimpleArcByBulgeType target = this;
            final SimpleArcByBulgeType leftObject = ((SimpleArcByBulgeType) left);
            final SimpleArcByBulgeType rightObject = ((SimpleArcByBulgeType) right);
            {
