...
public class UnitOfMeasurePropertyType implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
        ...
        if (draftCopy instanceof UnitOfMeasurePropertyType) {
            final UnitOfMeasurePropertyType copy = ((UnitOfMeasurePropertyType) draftCopy);
            {
                ...
                if (unitDefinitionShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    JAXBElement<UnitDefinitionType> copyUnitDefinition = ((JAXBElement<UnitDefinitionType> ) strategy.copy(LocatorUtils.property(locator, "unitDefinition", sourceUnitDefinition), sourceUnitDefinition, this.isSetUnitDefinition()));
        ...
        if (right instanceof UnitOfMeasurePropertyType) {
            ...
            final UnitOfMeasurePropertyType rightObject = ((UnitOfMeasurePropertyType) right);
            {
                ...
                if (unitDefinitionShouldBeMergedAndSet == Boolean.TRUE) {
                    ...
                    JAXBElement<UnitDefinitionType> mergedUnitDefinition = ((JAXBElement<UnitDefinitionType> ) strategy.merge(LocatorUtils.property(leftLocator, "unitDefinition", lhsUnitDefinition), LocatorUtils.property(rightLocator, "unitDefinition", rhsUnitDefinition), lhsUnitDefinition, rhsUnitDefinition, leftObject.isSetUnitDefinition(), rightObject.isSetUnitDefinition()));
