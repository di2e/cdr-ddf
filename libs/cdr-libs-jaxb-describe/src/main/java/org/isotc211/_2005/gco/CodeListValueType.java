...
public class CodeListValueType implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    @NotNull(message = "CodeListValueType.codeList {javax.validation.constraints.NotNull.message}")
    protected String codeList;
    @XmlAttribute(name = "codeListValue", required = true)
    @XmlSchemaType(name = "anyURI")
    @NotNull(message = "CodeListValueType.codeListValue {javax.validation.constraints.NotNull.message}")
