...
public class SCCRSPropertyType implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
        ...
        if (draftCopy instanceof SCCRSPropertyType) {
            final SCCRSPropertyType copy = ((SCCRSPropertyType) draftCopy);
            {
                ...
                if (abstractCRSShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    JAXBElement<AbstractCRSType> copyAbstractCRS = ((JAXBElement<AbstractCRSType> ) strategy.copy(LocatorUtils.property(locator, "abstractCRS", sourceAbstractCRS), sourceAbstractCRS, this.isSetAbstractCRS()));
        ...
        if (right instanceof SCCRSPropertyType) {
            ...
            final SCCRSPropertyType rightObject = ((SCCRSPropertyType) right);
            {
                ...
                if (abstractCRSShouldBeMergedAndSet == Boolean.TRUE) {
                    ...
                    JAXBElement<AbstractCRSType> mergedAbstractCRS = ((JAXBElement<AbstractCRSType> ) strategy.merge(LocatorUtils.property(leftLocator, "abstractCRS", lhsAbstractCRS), LocatorUtils.property(rightLocator, "abstractCRS", rhsAbstractCRS), lhsAbstractCRS, rhsAbstractCRS, leftObject.isSetAbstractCRS(), rightObject.isSetAbstractCRS()));
