...
/**
 * Depth Measure Type: A datatype representing the distance of a point from a chosen reference surface measured downward along the direction of gravity with positive values being below the reference surface. [desc] Conventionally measured from Mean Sea level (MSL) or a geoid (for example: Earth Gravity Model 1996 (EGM96)); may also be measured from a Todal Datum or River Datum.
 * 
 * <p>Java class for DepthMeasureType complex type.
 * 
...
@XmlType(name = "DepthMeasureType")
public class DepthMeasureType
    extends MeasureType
    implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    @NotNull(message = "DepthMeasureType.verticalDatum {javax.validation.constraints.NotNull.message}")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final DepthMeasureType that = ((DepthMeasureType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof DepthMeasureType) {
            final DepthMeasureType copy = ((DepthMeasureType) draftCopy);
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        ...
        if (right instanceof DepthMeasureType) {
            final DepthMeasureType target = this;
            final DepthMeasureType leftObject = ((DepthMeasureType) left);
            final DepthMeasureType rightObject = ((DepthMeasureType) right);
            {
