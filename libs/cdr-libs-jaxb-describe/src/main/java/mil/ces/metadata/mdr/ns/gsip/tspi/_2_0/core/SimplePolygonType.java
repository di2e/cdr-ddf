 ...
 *   &lt;complexContent&gt;
 *     &lt;extension base="{http://www.opengis.net/gml/3.3/ce}SimplePolygonType"&gt;
 *       &lt;sequence&gt;
...
@XmlType(name = "SimplePolygonType", propOrder = {
    "horizResolutionCategory",
    "vertResolutionCategory",
    "horizPresentation",
    "vertPresentation"
})
public class SimplePolygonType
    extends net.opengis.gml._3_3.ce.SimplePolygonType
    implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final SimplePolygonType that = ((SimplePolygonType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof SimplePolygonType) {
            final SimplePolygonType copy = ((SimplePolygonType) draftCopy);
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        ...
        if (right instanceof SimplePolygonType) {
            final SimplePolygonType target = this;
            final SimplePolygonType leftObject = ((SimplePolygonType) left);
            final SimplePolygonType rightObject = ((SimplePolygonType) right);
            {
