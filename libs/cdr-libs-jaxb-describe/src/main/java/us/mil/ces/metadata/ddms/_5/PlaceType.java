 ...
 *         &lt;element ref="{urn:us:mil:ces:metadata:ddms:5}geographicIdentifier"/&gt;
 *         &lt;element ref="{urn:us:mil:ces:metadata:ddms:5}boundingGeometry"/&gt;
 *         &lt;element ref="{urn:us:mil:ces:metadata:ddms:5}postalAddress"/&gt;
 *       &lt;/choice&gt;
 *       &lt;attGroup ref="{urn:us:mil:ces:metadata:ddms:5}SecurityAttributesOptionGroup"/&gt;
 *       &lt;attribute name="precedence" type="{urn:us:mil:ces:metadata:ddms:5}simpleTokenType" /&gt;
...
@XmlType(name = "PlaceType", propOrder = {
    "geographicIdentifierOrBoundingGeometryOrPostalAddress"
})
public class PlaceType implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{

    private final static long serialVersionUID = 1L;
    @XmlElements({
        @XmlElement(name = "geographicIdentifier", type = GeographicIdentifier.class),
        @XmlElement(name = "boundingGeometry", type = BoundingGeometryType.class),
        @XmlElement(name = "postalAddress", type = PostalAddress.class)
    })
    @Size(min = 1)
    protected List<Serializable> geographicIdentifierOrBoundingGeometryOrPostalAddress;
    @XmlAttribute(name = "precedence", namespace = "urn:us:mil:ces:metadata:ddms:5")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @Size(min = 1)
    protected String precedence;
    @XmlAttribute(name = "order", namespace = "urn:us:mil:ces:metadata:ddms:5")
    ...
    /**
     * Gets the value of the geographicIdentifierOrBoundingGeometryOrPostalAddress property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the geographicIdentifierOrBoundingGeometryOrPostalAddress property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getGeographicIdentifierOrBoundingGeometryOrPostalAddress().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link GeographicIdentifier }
     * {@link BoundingGeometryType }
     * {@link PostalAddress }
     * 
     * 
     */
    public List<Serializable> getGeographicIdentifierOrBoundingGeometryOrPostalAddress() {
        if (geographicIdentifierOrBoundingGeometryOrPostalAddress == null) {
            geographicIdentifierOrBoundingGeometryOrPostalAddress = new ArrayList<Serializable>();
        }
        return this.geographicIdentifierOrBoundingGeometryOrPostalAddress;
    }

    public boolean isSetGeographicIdentifierOrBoundingGeometryOrPostalAddress() {
        return ((this.geographicIdentifierOrBoundingGeometryOrPostalAddress!= null)&&(!this.geographicIdentifierOrBoundingGeometryOrPostalAddress.isEmpty()));
    }

    public void unsetGeographicIdentifierOrBoundingGeometryOrPostalAddress() {
        this.geographicIdentifierOrBoundingGeometryOrPostalAddress = null;
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            List<Serializable> theGeographicIdentifierOrBoundingGeometryOrPostalAddress;
            theGeographicIdentifierOrBoundingGeometryOrPostalAddress = (this.isSetGeographicIdentifierOrBoundingGeometryOrPostalAddress()?this.getGeographicIdentifierOrBoundingGeometryOrPostalAddress():null);
            strategy.appendField(locator, this, "geographicIdentifierOrBoundingGeometryOrPostalAddress", buffer, theGeographicIdentifierOrBoundingGeometryOrPostalAddress, this.isSetGeographicIdentifierOrBoundingGeometryOrPostalAddress());
        }
        {
            String thePrecedence;
            thePrecedence = this.getPrecedence();
            strategy.appendField(locator, this, "precedence", buffer, thePrecedence, this.isSetPrecedence());
        }
        {
            int theOrder;
            theOrder = (this.isSetOrder()?this.getOrder(): 0);
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final PlaceType that = ((PlaceType) object);
        {
            List<Serializable> lhsGeographicIdentifierOrBoundingGeometryOrPostalAddress;
            lhsGeographicIdentifierOrBoundingGeometryOrPostalAddress = (this.isSetGeographicIdentifierOrBoundingGeometryOrPostalAddress()?this.getGeographicIdentifierOrBoundingGeometryOrPostalAddress():null);
            List<Serializable> rhsGeographicIdentifierOrBoundingGeometryOrPostalAddress;
            rhsGeographicIdentifierOrBoundingGeometryOrPostalAddress = (that.isSetGeographicIdentifierOrBoundingGeometryOrPostalAddress()?that.getGeographicIdentifierOrBoundingGeometryOrPostalAddress():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "geographicIdentifierOrBoundingGeometryOrPostalAddress", lhsGeographicIdentifierOrBoundingGeometryOrPostalAddress), LocatorUtils.property(thatLocator, "geographicIdentifierOrBoundingGeometryOrPostalAddress", rhsGeographicIdentifierOrBoundingGeometryOrPostalAddress), lhsGeographicIdentifierOrBoundingGeometryOrPostalAddress, rhsGeographicIdentifierOrBoundingGeometryOrPostalAddress, this.isSetGeographicIdentifierOrBoundingGeometryOrPostalAddress(), that.isSetGeographicIdentifierOrBoundingGeometryOrPostalAddress())) {
                return false;
            }
        }
        {
            String lhsPrecedence;
            lhsPrecedence = this.getPrecedence();
            String rhsPrecedence;
            rhsPrecedence = that.getPrecedence();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "precedence", lhsPrecedence), LocatorUtils.property(thatLocator, "precedence", rhsPrecedence), lhsPrecedence, rhsPrecedence, this.isSetPrecedence(), that.isSetPrecedence())) {
                return false;
            }
        }
        {
            int lhsOrder;
            lhsOrder = (this.isSetOrder()?this.getOrder(): 0);
            int rhsOrder;
            rhsOrder = (that.isSetOrder()?that.getOrder(): 0);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            List<Serializable> theGeographicIdentifierOrBoundingGeometryOrPostalAddress;
            theGeographicIdentifierOrBoundingGeometryOrPostalAddress = (this.isSetGeographicIdentifierOrBoundingGeometryOrPostalAddress()?this.getGeographicIdentifierOrBoundingGeometryOrPostalAddress():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "geographicIdentifierOrBoundingGeometryOrPostalAddress", theGeographicIdentifierOrBoundingGeometryOrPostalAddress), currentHashCode, theGeographicIdentifierOrBoundingGeometryOrPostalAddress, this.isSetGeographicIdentifierOrBoundingGeometryOrPostalAddress());
        }
        {
            String thePrecedence;
            thePrecedence = this.getPrecedence();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "precedence", thePrecedence), currentHashCode, thePrecedence, this.isSetPrecedence());
        }
        {
            int theOrder;
            theOrder = (this.isSetOrder()?this.getOrder(): 0);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof PlaceType) {
            final PlaceType copy = ((PlaceType) draftCopy);
            {
                Boolean geographicIdentifierOrBoundingGeometryOrPostalAddressShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetGeographicIdentifierOrBoundingGeometryOrPostalAddress());
                if (geographicIdentifierOrBoundingGeometryOrPostalAddressShouldBeCopiedAndSet == Boolean.TRUE) {
                    List<Serializable> sourceGeographicIdentifierOrBoundingGeometryOrPostalAddress;
                    sourceGeographicIdentifierOrBoundingGeometryOrPostalAddress = (this.isSetGeographicIdentifierOrBoundingGeometryOrPostalAddress()?this.getGeographicIdentifierOrBoundingGeometryOrPostalAddress():null);
                    @SuppressWarnings("unchecked")
                    List<Serializable> copyGeographicIdentifierOrBoundingGeometryOrPostalAddress = ((List<Serializable> ) strategy.copy(LocatorUtils.property(locator, "geographicIdentifierOrBoundingGeometryOrPostalAddress", sourceGeographicIdentifierOrBoundingGeometryOrPostalAddress), sourceGeographicIdentifierOrBoundingGeometryOrPostalAddress, this.isSetGeographicIdentifierOrBoundingGeometryOrPostalAddress()));
                    copy.unsetGeographicIdentifierOrBoundingGeometryOrPostalAddress();
                    if (copyGeographicIdentifierOrBoundingGeometryOrPostalAddress!= null) {
                        List<Serializable> uniqueGeographicIdentifierOrBoundingGeometryOrPostalAddressl = copy.getGeographicIdentifierOrBoundingGeometryOrPostalAddress();
                        uniqueGeographicIdentifierOrBoundingGeometryOrPostalAddressl.addAll(copyGeographicIdentifierOrBoundingGeometryOrPostalAddress);
                    }
                } else {
                    if (geographicIdentifierOrBoundingGeometryOrPostalAddressShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.unsetGeographicIdentifierOrBoundingGeometryOrPostalAddress();
                    }
                }
            }
            {
                Boolean precedenceShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetPrecedence());
                if (precedenceShouldBeCopiedAndSet == Boolean.TRUE) {
                    String sourcePrecedence;
                    sourcePrecedence = this.getPrecedence();
                    String copyPrecedence = ((String) strategy.copy(LocatorUtils.property(locator, "precedence", sourcePrecedence), sourcePrecedence, this.isSetPrecedence()));
                    copy.setPrecedence(copyPrecedence);
                } else {
                    if (precedenceShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.precedence = null;
                    }
                }
            }
            {
                ...
                if (orderShouldBeCopiedAndSet == Boolean.TRUE) {
                    int sourceOrder;
                    sourceOrder = (this.isSetOrder()?this.getOrder(): 0);
                    int copyOrder = strategy.copy(LocatorUtils.property(locator, "order", sourceOrder), sourceOrder, this.isSetOrder());
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof PlaceType) {
            final PlaceType target = this;
            final PlaceType leftObject = ((PlaceType) left);
            final PlaceType rightObject = ((PlaceType) right);
            {
                Boolean geographicIdentifierOrBoundingGeometryOrPostalAddressShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetGeographicIdentifierOrBoundingGeometryOrPostalAddress(), rightObject.isSetGeographicIdentifierOrBoundingGeometryOrPostalAddress());
                if (geographicIdentifierOrBoundingGeometryOrPostalAddressShouldBeMergedAndSet == Boolean.TRUE) {
                    List<Serializable> lhsGeographicIdentifierOrBoundingGeometryOrPostalAddress;
                    lhsGeographicIdentifierOrBoundingGeometryOrPostalAddress = (leftObject.isSetGeographicIdentifierOrBoundingGeometryOrPostalAddress()?leftObject.getGeographicIdentifierOrBoundingGeometryOrPostalAddress():null);
                    List<Serializable> rhsGeographicIdentifierOrBoundingGeometryOrPostalAddress;
                    rhsGeographicIdentifierOrBoundingGeometryOrPostalAddress = (rightObject.isSetGeographicIdentifierOrBoundingGeometryOrPostalAddress()?rightObject.getGeographicIdentifierOrBoundingGeometryOrPostalAddress():null);
                    List<Serializable> mergedGeographicIdentifierOrBoundingGeometryOrPostalAddress = ((List<Serializable> ) strategy.merge(LocatorUtils.property(leftLocator, "geographicIdentifierOrBoundingGeometryOrPostalAddress", lhsGeographicIdentifierOrBoundingGeometryOrPostalAddress), LocatorUtils.property(rightLocator, "geographicIdentifierOrBoundingGeometryOrPostalAddress", rhsGeographicIdentifierOrBoundingGeometryOrPostalAddress), lhsGeographicIdentifierOrBoundingGeometryOrPostalAddress, rhsGeographicIdentifierOrBoundingGeometryOrPostalAddress, leftObject.isSetGeographicIdentifierOrBoundingGeometryOrPostalAddress(), rightObject.isSetGeographicIdentifierOrBoundingGeometryOrPostalAddress()));
                    target.unsetGeographicIdentifierOrBoundingGeometryOrPostalAddress();
                    if (mergedGeographicIdentifierOrBoundingGeometryOrPostalAddress!= null) {
                        List<Serializable> uniqueGeographicIdentifierOrBoundingGeometryOrPostalAddressl = target.getGeographicIdentifierOrBoundingGeometryOrPostalAddress();
                        uniqueGeographicIdentifierOrBoundingGeometryOrPostalAddressl.addAll(mergedGeographicIdentifierOrBoundingGeometryOrPostalAddress);
                    }
                } else {
                    if (geographicIdentifierOrBoundingGeometryOrPostalAddressShouldBeMergedAndSet == Boolean.FALSE) {
                        target.unsetGeographicIdentifierOrBoundingGeometryOrPostalAddress();
                    }
                }
            }
            {
                Boolean precedenceShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetPrecedence(), rightObject.isSetPrecedence());
                if (precedenceShouldBeMergedAndSet == Boolean.TRUE) {
                    String lhsPrecedence;
                    lhsPrecedence = leftObject.getPrecedence();
                    String rhsPrecedence;
                    rhsPrecedence = rightObject.getPrecedence();
                    String mergedPrecedence = ((String) strategy.merge(LocatorUtils.property(leftLocator, "precedence", lhsPrecedence), LocatorUtils.property(rightLocator, "precedence", rhsPrecedence), lhsPrecedence, rhsPrecedence, leftObject.isSetPrecedence(), rightObject.isSetPrecedence()));
                    target.setPrecedence(mergedPrecedence);
                } else {
                    if (precedenceShouldBeMergedAndSet == Boolean.FALSE) {
                        target.precedence = null;
                    }
                }
            }
            {
                ...
                if (orderShouldBeMergedAndSet == Boolean.TRUE) {
                    int lhsOrder;
                    lhsOrder = (leftObject.isSetOrder()?leftObject.getOrder(): 0);
                    int rhsOrder;
                    rhsOrder = (rightObject.isSetOrder()?rightObject.getOrder(): 0);
                    int mergedOrder = ((int) strategy.merge(LocatorUtils.property(leftLocator, "order", lhsOrder), LocatorUtils.property(rightLocator, "order", rhsOrder), lhsOrder, rhsOrder, leftObject.isSetOrder(), rightObject.isSetOrder()));
    ...
    public void setGeographicIdentifierOrBoundingGeometryOrPostalAddress(List<Serializable> value) {
        this.geographicIdentifierOrBoundingGeometryOrPostalAddress = null;
        if (value!= null) {
            List<Serializable> draftl = this.getGeographicIdentifierOrBoundingGeometryOrPostalAddress();
            draftl.addAll(value);
        }
    }
