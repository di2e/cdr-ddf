...
/**
 * <p>Java class for ResourceManagementType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ResourceManagementType"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="taskingInfo" type="{urn:us:mil:ces:metadata:ddms:5}TaskingInfoType" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "ResourceManagementType", propOrder = {
    "recordsManagementInfo",
    "revisionRecall",
    "taskingInfo",
    "processingInfo"
})
public class ResourceManagementType implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    @Valid
    protected List<TaskingInfoType> taskingInfo;
    @Valid
    ...
    /**
     * Gets the value of the taskingInfo property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the taskingInfo property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getTaskingInfo().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link TaskingInfoType }
     * 
     * 
     */
    public List<TaskingInfoType> getTaskingInfo() {
        if (taskingInfo == null) {
            taskingInfo = new ArrayList<TaskingInfoType>();
        }
        return this.taskingInfo;
    }

    public boolean isSetTaskingInfo() {
        return ((this.taskingInfo!= null)&&(!this.taskingInfo.isEmpty()));
    }

    public void unsetTaskingInfo() {
        this.taskingInfo = null;
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        {
            List<TaskingInfoType> theTaskingInfo;
            theTaskingInfo = (this.isSetTaskingInfo()?this.getTaskingInfo():null);
            strategy.appendField(locator, this, "taskingInfo", buffer, theTaskingInfo, this.isSetTaskingInfo());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ResourceManagementType that = ((ResourceManagementType) object);
        {
        ...
        {
            List<TaskingInfoType> lhsTaskingInfo;
            lhsTaskingInfo = (this.isSetTaskingInfo()?this.getTaskingInfo():null);
            List<TaskingInfoType> rhsTaskingInfo;
            rhsTaskingInfo = (that.isSetTaskingInfo()?that.getTaskingInfo():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "taskingInfo", lhsTaskingInfo), LocatorUtils.property(thatLocator, "taskingInfo", rhsTaskingInfo), lhsTaskingInfo, rhsTaskingInfo, this.isSetTaskingInfo(), that.isSetTaskingInfo())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        }
        {
            List<TaskingInfoType> theTaskingInfo;
            theTaskingInfo = (this.isSetTaskingInfo()?this.getTaskingInfo():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "taskingInfo", theTaskingInfo), currentHashCode, theTaskingInfo, this.isSetTaskingInfo());
        }
        {
            List<ProcessingInfoType> theProcessingInfo;
            theProcessingInfo = (this.isSetProcessingInfo()?this.getProcessingInfo():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof ResourceManagementType) {
            final ResourceManagementType copy = ((ResourceManagementType) draftCopy);
            {
            ...
            {
                Boolean taskingInfoShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetTaskingInfo());
                if (taskingInfoShouldBeCopiedAndSet == Boolean.TRUE) {
                    List<TaskingInfoType> sourceTaskingInfo;
                    sourceTaskingInfo = (this.isSetTaskingInfo()?this.getTaskingInfo():null);
                    @SuppressWarnings("unchecked")
                    List<TaskingInfoType> copyTaskingInfo = ((List<TaskingInfoType> ) strategy.copy(LocatorUtils.property(locator, "taskingInfo", sourceTaskingInfo), sourceTaskingInfo, this.isSetTaskingInfo()));
                    copy.unsetTaskingInfo();
                    if (copyTaskingInfo!= null) {
                        List<TaskingInfoType> uniqueTaskingInfol = copy.getTaskingInfo();
                        uniqueTaskingInfol.addAll(copyTaskingInfo);
                    }
                } else {
                    if (taskingInfoShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.unsetTaskingInfo();
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof ResourceManagementType) {
            final ResourceManagementType target = this;
            final ResourceManagementType leftObject = ((ResourceManagementType) left);
            final ResourceManagementType rightObject = ((ResourceManagementType) right);
            {
            ...
            {
                Boolean taskingInfoShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetTaskingInfo(), rightObject.isSetTaskingInfo());
                if (taskingInfoShouldBeMergedAndSet == Boolean.TRUE) {
                    List<TaskingInfoType> lhsTaskingInfo;
                    lhsTaskingInfo = (leftObject.isSetTaskingInfo()?leftObject.getTaskingInfo():null);
                    List<TaskingInfoType> rhsTaskingInfo;
                    rhsTaskingInfo = (rightObject.isSetTaskingInfo()?rightObject.getTaskingInfo():null);
                    List<TaskingInfoType> mergedTaskingInfo = ((List<TaskingInfoType> ) strategy.merge(LocatorUtils.property(leftLocator, "taskingInfo", lhsTaskingInfo), LocatorUtils.property(rightLocator, "taskingInfo", rhsTaskingInfo), lhsTaskingInfo, rhsTaskingInfo, leftObject.isSetTaskingInfo(), rightObject.isSetTaskingInfo()));
                    target.unsetTaskingInfo();
                    if (mergedTaskingInfo!= null) {
                        List<TaskingInfoType> uniqueTaskingInfol = target.getTaskingInfo();
                        uniqueTaskingInfol.addAll(mergedTaskingInfo);
                    }
                } else {
                    if (taskingInfoShouldBeMergedAndSet == Boolean.FALSE) {
                        target.unsetTaskingInfo();
                    }
                }
            }
    ...
    public void setTaskingInfo(List<TaskingInfoType> value) {
        this.taskingInfo = null;
        if (value!= null) {
            List<TaskingInfoType> draftl = this.getTaskingInfo();
            draftl.addAll(value);
        }
    }
