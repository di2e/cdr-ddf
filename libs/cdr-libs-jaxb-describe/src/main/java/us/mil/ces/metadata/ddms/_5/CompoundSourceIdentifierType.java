...
/**
 * <p>Java class for CompoundSourceIdentifierType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CompoundSourceIdentifierType"&gt;
 *   &lt;complexContent&gt;
 ...
 *       &lt;attribute name="schemaQualifier" type="{urn:us:mil:ces:metadata:ddms:5}simpleTokenType" /&gt;
 *       &lt;attribute name="schemaHref" type="{http://www.w3.org/2001/XMLSchema}anyURI" /&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
@XmlType(name = "CompoundSourceIdentifierType")
public class CompoundSourceIdentifierType implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    @XmlAttribute(name = "schemaQualifier", namespace = "urn:us:mil:ces:metadata:ddms:5")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @Size(min = 1)
    protected String schemaQualifier;
    @XmlAttribute(name = "schemaHref", namespace = "urn:us:mil:ces:metadata:ddms:5")
    @XmlSchemaType(name = "anyURI")
    protected String schemaHref;
    ...
    /**
     * Gets the value of the schemaQualifier property.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of the schemaQualifier property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setSchemaQualifier(String value) {
        this.schemaQualifier = value;
    }

    public boolean isSetSchemaQualifier() {
        return (this.schemaQualifier!= null);
    }

    /**
     * Gets the value of the schemaHref property.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of the schemaHref property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setSchemaHref(String value) {
        this.schemaHref = value;
    }

    public boolean isSetSchemaHref() {
        return (this.schemaHref!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        {
            String theSchemaQualifier;
            theSchemaQualifier = this.getSchemaQualifier();
            strategy.appendField(locator, this, "schemaQualifier", buffer, theSchemaQualifier, this.isSetSchemaQualifier());
        }
        {
            String theSchemaHref;
            theSchemaHref = this.getSchemaHref();
            strategy.appendField(locator, this, "schemaHref", buffer, theSchemaHref, this.isSetSchemaHref());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final CompoundSourceIdentifierType that = ((CompoundSourceIdentifierType) object);
        {
            String lhsQualifier;
        ...
        {
            String lhsSchemaQualifier;
            lhsSchemaQualifier = this.getSchemaQualifier();
            String rhsSchemaQualifier;
            rhsSchemaQualifier = that.getSchemaQualifier();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "schemaQualifier", lhsSchemaQualifier), LocatorUtils.property(thatLocator, "schemaQualifier", rhsSchemaQualifier), lhsSchemaQualifier, rhsSchemaQualifier, this.isSetSchemaQualifier(), that.isSetSchemaQualifier())) {
                return false;
            }
        }
        {
            String lhsSchemaHref;
            lhsSchemaHref = this.getSchemaHref();
            String rhsSchemaHref;
            rhsSchemaHref = that.getSchemaHref();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "schemaHref", lhsSchemaHref), LocatorUtils.property(thatLocator, "schemaHref", rhsSchemaHref), lhsSchemaHref, rhsSchemaHref, this.isSetSchemaHref(), that.isSetSchemaHref())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        }
        {
            String theSchemaQualifier;
            theSchemaQualifier = this.getSchemaQualifier();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "schemaQualifier", theSchemaQualifier), currentHashCode, theSchemaQualifier, this.isSetSchemaQualifier());
        }
        {
            String theSchemaHref;
            theSchemaHref = this.getSchemaHref();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "schemaHref", theSchemaHref), currentHashCode, theSchemaHref, this.isSetSchemaHref());
        }
        {
            CVEnumISMClassificationAll theClassification;
            theClassification = this.getClassification();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof CompoundSourceIdentifierType) {
            final CompoundSourceIdentifierType copy = ((CompoundSourceIdentifierType) draftCopy);
            {
            ...
            {
                Boolean schemaQualifierShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetSchemaQualifier());
                if (schemaQualifierShouldBeCopiedAndSet == Boolean.TRUE) {
                    String sourceSchemaQualifier;
                    sourceSchemaQualifier = this.getSchemaQualifier();
                    String copySchemaQualifier = ((String) strategy.copy(LocatorUtils.property(locator, "schemaQualifier", sourceSchemaQualifier), sourceSchemaQualifier, this.isSetSchemaQualifier()));
                    copy.setSchemaQualifier(copySchemaQualifier);
                } else {
                    if (schemaQualifierShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.schemaQualifier = null;
                    }
                }
            }
            {
                Boolean schemaHrefShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetSchemaHref());
                if (schemaHrefShouldBeCopiedAndSet == Boolean.TRUE) {
                    String sourceSchemaHref;
                    sourceSchemaHref = this.getSchemaHref();
                    String copySchemaHref = ((String) strategy.copy(LocatorUtils.property(locator, "schemaHref", sourceSchemaHref), sourceSchemaHref, this.isSetSchemaHref()));
                    copy.setSchemaHref(copySchemaHref);
                } else {
                    if (schemaHrefShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.schemaHref = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof CompoundSourceIdentifierType) {
            final CompoundSourceIdentifierType target = this;
            final CompoundSourceIdentifierType leftObject = ((CompoundSourceIdentifierType) left);
            final CompoundSourceIdentifierType rightObject = ((CompoundSourceIdentifierType) right);
            {
            ...
            {
                Boolean schemaQualifierShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetSchemaQualifier(), rightObject.isSetSchemaQualifier());
                if (schemaQualifierShouldBeMergedAndSet == Boolean.TRUE) {
                    String lhsSchemaQualifier;
                    lhsSchemaQualifier = leftObject.getSchemaQualifier();
                    String rhsSchemaQualifier;
                    rhsSchemaQualifier = rightObject.getSchemaQualifier();
                    String mergedSchemaQualifier = ((String) strategy.merge(LocatorUtils.property(leftLocator, "schemaQualifier", lhsSchemaQualifier), LocatorUtils.property(rightLocator, "schemaQualifier", rhsSchemaQualifier), lhsSchemaQualifier, rhsSchemaQualifier, leftObject.isSetSchemaQualifier(), rightObject.isSetSchemaQualifier()));
                    target.setSchemaQualifier(mergedSchemaQualifier);
                } else {
                    if (schemaQualifierShouldBeMergedAndSet == Boolean.FALSE) {
                        target.schemaQualifier = null;
                    }
                }
            }
            {
                Boolean schemaHrefShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetSchemaHref(), rightObject.isSetSchemaHref());
                if (schemaHrefShouldBeMergedAndSet == Boolean.TRUE) {
                    String lhsSchemaHref;
                    lhsSchemaHref = leftObject.getSchemaHref();
                    String rhsSchemaHref;
                    rhsSchemaHref = rightObject.getSchemaHref();
                    String mergedSchemaHref = ((String) strategy.merge(LocatorUtils.property(leftLocator, "schemaHref", lhsSchemaHref), LocatorUtils.property(rightLocator, "schemaHref", rhsSchemaHref), lhsSchemaHref, rhsSchemaHref, leftObject.isSetSchemaHref(), rightObject.isSetSchemaHref()));
                    target.setSchemaHref(mergedSchemaHref);
                } else {
                    if (schemaHrefShouldBeMergedAndSet == Boolean.FALSE) {
                        target.schemaHref = null;
                    }
                }
            }
            {
