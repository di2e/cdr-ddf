...
/**
 * <p>Java class for NonStateActorCoverageType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="NonStateActorCoverageType"&gt;
 *   &lt;simpleContent&gt;
...
@XmlType(name = "NonStateActorCoverageType", propOrder = {
    "value"
})
public class NonStateActorCoverageType implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final NonStateActorCoverageType that = ((NonStateActorCoverageType) object);
        {
            String lhsValue;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof NonStateActorCoverageType) {
            final NonStateActorCoverageType copy = ((NonStateActorCoverageType) draftCopy);
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof NonStateActorCoverageType) {
            final NonStateActorCoverageType target = this;
            final NonStateActorCoverageType leftObject = ((NonStateActorCoverageType) left);
            final NonStateActorCoverageType rightObject = ((NonStateActorCoverageType) right);
            {
