 ...
 *         &lt;element ref="{urn:us:mil:ces:metadata:ddms:5}service"/&gt;
 *         &lt;element ref="{urn:us:mil:ces:metadata:ddms:5}unknown"/&gt;
 *       &lt;/choice&gt;
 *       &lt;attGroup ref="{urn:us:mil:ces:metadata:ddms:5}POCAttributesGroup"/&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
public class ContactInfoType implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        {
            UnknownType theUnknown;
            theUnknown = this.getUnknown();
            strategy.appendField(locator, this, "unknown", buffer, theUnknown, this.isSetUnknown());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ContactInfoType that = ((ContactInfoType) object);
        {
        ...
        {
            ServiceType lhsService;
            lhsService = this.getService();
            ServiceType rhsService;
        ...
        {
            UnknownType lhsUnknown;
            lhsUnknown = this.getUnknown();
            UnknownType rhsUnknown;
            rhsUnknown = that.getUnknown();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "unknown", lhsUnknown), LocatorUtils.property(thatLocator, "unknown", rhsUnknown), lhsUnknown, rhsUnknown, this.isSetUnknown(), that.isSetUnknown())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        }
        {
            UnknownType theUnknown;
            theUnknown = this.getUnknown();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "unknown", theUnknown), currentHashCode, theUnknown, this.isSetUnknown());
        }
        {
            CVEnumISMClassificationAll theClassification;
            theClassification = this.getClassification();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof ContactInfoType) {
            final ContactInfoType copy = ((ContactInfoType) draftCopy);
            {
            ...
            }
            {
                ...
                if (serviceShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    ServiceType copyService = ((ServiceType) strategy.copy(LocatorUtils.property(locator, "service", sourceService), sourceService, this.isSetService()));
            ...
            {
                Boolean unknownShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetUnknown());
                if (unknownShouldBeCopiedAndSet == Boolean.TRUE) {
                    UnknownType sourceUnknown;
                    sourceUnknown = this.getUnknown();
                    UnknownType copyUnknown = ((UnknownType) strategy.copy(LocatorUtils.property(locator, "unknown", sourceUnknown), sourceUnknown, this.isSetUnknown()));
                    copy.setUnknown(copyUnknown);
                } else {
                    if (unknownShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.unknown = null;
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof ContactInfoType) {
            final ContactInfoType target = this;
            final ContactInfoType leftObject = ((ContactInfoType) left);
            final ContactInfoType rightObject = ((ContactInfoType) right);
            {
            ...
            }
            {
                ...
                if (serviceShouldBeMergedAndSet == Boolean.TRUE) {
                    ...
                    ServiceType mergedService = ((ServiceType) strategy.merge(LocatorUtils.property(leftLocator, "service", lhsService), LocatorUtils.property(rightLocator, "service", rhsService), lhsService, rhsService, leftObject.isSetService(), rightObject.isSetService()));
            ...
            {
                Boolean unknownShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetUnknown(), rightObject.isSetUnknown());
                if (unknownShouldBeMergedAndSet == Boolean.TRUE) {
                    UnknownType lhsUnknown;
                    lhsUnknown = leftObject.getUnknown();
                    UnknownType rhsUnknown;
                    rhsUnknown = rightObject.getUnknown();
                    UnknownType mergedUnknown = ((UnknownType) strategy.merge(LocatorUtils.property(leftLocator, "unknown", lhsUnknown), LocatorUtils.property(rightLocator, "unknown", rhsUnknown), lhsUnknown, rhsUnknown, leftObject.isSetUnknown(), rightObject.isSetUnknown()));
                    target.setUnknown(mergedUnknown);
                } else {
                    if (unknownShouldBeMergedAndSet == Boolean.FALSE) {
                        target.unknown = null;
                    }
                }
            }
