...
public class DescriptionType implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    @NotNull(message = "DescriptionType.classification {javax.validation.constraints.NotNull.message}")
    ...
    @NotNull(message = "DescriptionType.ownerProducer {javax.validation.constraints.NotNull.message}")
