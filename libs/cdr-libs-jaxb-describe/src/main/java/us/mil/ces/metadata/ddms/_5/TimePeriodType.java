...
public class TimePeriodType implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
     ...
     *     
     */
    public void setApproximableStart(ApproximableDateType value) {
        this.approximableStart = value;
    }

    public boolean isSetApproximableStart() {
        return (this.approximableStart!= null);
    }
     ...
     *     
     */
    public void setApproximableEnd(ApproximableDateType value) {
        this.approximableEnd = value;
    }

    public boolean isSetApproximableEnd() {
        return (this.approximableEnd!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        {
            List<String> theStart;
            theStart = (this.isSetStart()?this.getStart():null);
            strategy.appendField(locator, this, "start", buffer, theStart, this.isSetStart());
        }
        {
            ApproximableDateType theApproximableStart;
            theApproximableStart = this.getApproximableStart();
            strategy.appendField(locator, this, "approximableStart", buffer, theApproximableStart, this.isSetApproximableStart());
        }
        {
            List<String> theEnd;
            theEnd = (this.isSetEnd()?this.getEnd():null);
            strategy.appendField(locator, this, "end", buffer, theEnd, this.isSetEnd());
        }
        {
            ApproximableDateType theApproximableEnd;
            theApproximableEnd = this.getApproximableEnd();
            strategy.appendField(locator, this, "approximableEnd", buffer, theApproximableEnd, this.isSetApproximableEnd());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            List<String> lhsStart;
            lhsStart = (this.isSetStart()?this.getStart():null);
            List<String> rhsStart;
            rhsStart = (that.isSetStart()?that.getStart():null);
        ...
        {
            ApproximableDateType lhsApproximableStart;
            lhsApproximableStart = this.getApproximableStart();
            ApproximableDateType rhsApproximableStart;
            rhsApproximableStart = that.getApproximableStart();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "approximableStart", lhsApproximableStart), LocatorUtils.property(thatLocator, "approximableStart", rhsApproximableStart), lhsApproximableStart, rhsApproximableStart, this.isSetApproximableStart(), that.isSetApproximableStart())) {
                return false;
            }
        }
        {
            List<String> lhsEnd;
            lhsEnd = (this.isSetEnd()?this.getEnd():null);
            List<String> rhsEnd;
            rhsEnd = (that.isSetEnd()?that.getEnd():null);
        ...
        {
            ApproximableDateType lhsApproximableEnd;
            lhsApproximableEnd = this.getApproximableEnd();
            ApproximableDateType rhsApproximableEnd;
            rhsApproximableEnd = that.getApproximableEnd();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "approximableEnd", lhsApproximableEnd), LocatorUtils.property(thatLocator, "approximableEnd", rhsApproximableEnd), lhsApproximableEnd, rhsApproximableEnd, this.isSetApproximableEnd(), that.isSetApproximableEnd())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        }
        {
            ApproximableDateType theApproximableStart;
            theApproximableStart = this.getApproximableStart();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "approximableStart", theApproximableStart), currentHashCode, theApproximableStart, this.isSetApproximableStart());
        }
        {
            List<String> theEnd;
            theEnd = (this.isSetEnd()?this.getEnd():null);
        ...
        }
        {
            ApproximableDateType theApproximableEnd;
            theApproximableEnd = this.getApproximableEnd();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "approximableEnd", theApproximableEnd), currentHashCode, theApproximableEnd, this.isSetApproximableEnd());
        }
        {
            CVEnumISMClassificationAll theClassification;
            theClassification = this.getClassification();
        ...
        if (draftCopy instanceof TimePeriodType) {
            ...
            }
            {
                ...
                if (startShouldBeCopiedAndSet == Boolean.TRUE) {
                    List<String> sourceStart;
                    sourceStart = (this.isSetStart()?this.getStart():null);
                    @SuppressWarnings("unchecked")
                    List<String> copyStart = ((List<String> ) strategy.copy(LocatorUtils.property(locator, "start", sourceStart), sourceStart, this.isSetStart()));
                    copy.unsetStart();
                    if (copyStart!= null) {
                        List<String> uniqueStartl = copy.getStart();
                        uniqueStartl.addAll(copyStart);
                    }
                } else {
            ...
            {
                Boolean approximableStartShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetApproximableStart());
                if (approximableStartShouldBeCopiedAndSet == Boolean.TRUE) {
                    ApproximableDateType sourceApproximableStart;
                    sourceApproximableStart = this.getApproximableStart();
                    ApproximableDateType copyApproximableStart = ((ApproximableDateType) strategy.copy(LocatorUtils.property(locator, "approximableStart", sourceApproximableStart), sourceApproximableStart, this.isSetApproximableStart()));
                    copy.setApproximableStart(copyApproximableStart);
                } else {
                    if (approximableStartShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.approximableStart = null;
                    }
                }
            }
            {
                ...
                if (endShouldBeCopiedAndSet == Boolean.TRUE) {
                    List<String> sourceEnd;
                    sourceEnd = (this.isSetEnd()?this.getEnd():null);
                    @SuppressWarnings("unchecked")
                    List<String> copyEnd = ((List<String> ) strategy.copy(LocatorUtils.property(locator, "end", sourceEnd), sourceEnd, this.isSetEnd()));
                    copy.unsetEnd();
                    if (copyEnd!= null) {
                        List<String> uniqueEndl = copy.getEnd();
                        uniqueEndl.addAll(copyEnd);
                    }
                } else {
            ...
            {
                Boolean approximableEndShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetApproximableEnd());
                if (approximableEndShouldBeCopiedAndSet == Boolean.TRUE) {
                    ApproximableDateType sourceApproximableEnd;
                    sourceApproximableEnd = this.getApproximableEnd();
                    ApproximableDateType copyApproximableEnd = ((ApproximableDateType) strategy.copy(LocatorUtils.property(locator, "approximableEnd", sourceApproximableEnd), sourceApproximableEnd, this.isSetApproximableEnd()));
                    copy.setApproximableEnd(copyApproximableEnd);
                } else {
                    if (approximableEndShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.approximableEnd = null;
                    }
                }
            }
            {
        ...
        if (right instanceof TimePeriodType) {
            ...
            }
            {
                ...
                if (startShouldBeMergedAndSet == Boolean.TRUE) {
                    List<String> lhsStart;
                    lhsStart = (leftObject.isSetStart()?leftObject.getStart():null);
                    List<String> rhsStart;
                    rhsStart = (rightObject.isSetStart()?rightObject.getStart():null);
                    List<String> mergedStart = ((List<String> ) strategy.merge(LocatorUtils.property(leftLocator, "start", lhsStart), LocatorUtils.property(rightLocator, "start", rhsStart), lhsStart, rhsStart, leftObject.isSetStart(), rightObject.isSetStart()));
                    target.unsetStart();
                    if (mergedStart!= null) {
                        List<String> uniqueStartl = target.getStart();
                        uniqueStartl.addAll(mergedStart);
                    }
                } else {
            ...
            {
                Boolean approximableStartShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetApproximableStart(), rightObject.isSetApproximableStart());
                if (approximableStartShouldBeMergedAndSet == Boolean.TRUE) {
                    ApproximableDateType lhsApproximableStart;
                    lhsApproximableStart = leftObject.getApproximableStart();
                    ApproximableDateType rhsApproximableStart;
                    rhsApproximableStart = rightObject.getApproximableStart();
                    ApproximableDateType mergedApproximableStart = ((ApproximableDateType) strategy.merge(LocatorUtils.property(leftLocator, "approximableStart", lhsApproximableStart), LocatorUtils.property(rightLocator, "approximableStart", rhsApproximableStart), lhsApproximableStart, rhsApproximableStart, leftObject.isSetApproximableStart(), rightObject.isSetApproximableStart()));
                    target.setApproximableStart(mergedApproximableStart);
                } else {
                    if (approximableStartShouldBeMergedAndSet == Boolean.FALSE) {
                        target.approximableStart = null;
                    }
                }
            }
            {
                ...
                if (endShouldBeMergedAndSet == Boolean.TRUE) {
                    List<String> lhsEnd;
                    lhsEnd = (leftObject.isSetEnd()?leftObject.getEnd():null);
                    List<String> rhsEnd;
                    rhsEnd = (rightObject.isSetEnd()?rightObject.getEnd():null);
                    List<String> mergedEnd = ((List<String> ) strategy.merge(LocatorUtils.property(leftLocator, "end", lhsEnd), LocatorUtils.property(rightLocator, "end", rhsEnd), lhsEnd, rhsEnd, leftObject.isSetEnd(), rightObject.isSetEnd()));
                    target.unsetEnd();
                    if (mergedEnd!= null) {
                        List<String> uniqueEndl = target.getEnd();
                        uniqueEndl.addAll(mergedEnd);
                    }
                } else {
            ...
            {
                Boolean approximableEndShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetApproximableEnd(), rightObject.isSetApproximableEnd());
                if (approximableEndShouldBeMergedAndSet == Boolean.TRUE) {
                    ApproximableDateType lhsApproximableEnd;
                    lhsApproximableEnd = leftObject.getApproximableEnd();
                    ApproximableDateType rhsApproximableEnd;
                    rhsApproximableEnd = rightObject.getApproximableEnd();
                    ApproximableDateType mergedApproximableEnd = ((ApproximableDateType) strategy.merge(LocatorUtils.property(leftLocator, "approximableEnd", lhsApproximableEnd), LocatorUtils.property(rightLocator, "approximableEnd", rhsApproximableEnd), lhsApproximableEnd, rhsApproximableEnd, leftObject.isSetApproximableEnd(), rightObject.isSetApproximableEnd()));
                    target.setApproximableEnd(mergedApproximableEnd);
                } else {
                    if (approximableEndShouldBeMergedAndSet == Boolean.FALSE) {
                        target.approximableEnd = null;
                    }
                }
            }
            {
    ...
    public void setStart(List<String> value) {
        this.start = null;
        if (value!= null) {
            List<String> draftl = this.getStart();
            draftl.addAll(value);
        }
    }

    public void setEnd(List<String> value) {
        this.end = null;
        if (value!= null) {
            List<String> draftl = this.getEnd();
            draftl.addAll(value);
        }
    }
