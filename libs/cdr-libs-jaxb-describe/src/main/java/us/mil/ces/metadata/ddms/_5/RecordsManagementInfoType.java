...
/**
 * <p>Java class for RecordsManagementInfoType complex type.
 * 
...
@XmlType(name = "RecordsManagementInfoType", propOrder = {
    "recordKeeper",
    "applicationSoftware"
})
public class RecordsManagementInfoType implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    @XmlAttribute(name = "vitalRecordIndicator", namespace = "urn:us:mil:ces:metadata:ddms:5")
     ...
     * @return
     *     possible object is
     *     {@link RecordsManagementInfoType.RecordKeeper }
     *     
     */
     ...
     *     
     */
    public void setRecordKeeper(RecordsManagementInfoType.RecordKeeper value) {
        this.recordKeeper = value;
    }

    public boolean isSetRecordKeeper() {
        return (this.recordKeeper!= null);
    }
     ...
     * @return
     *     possible object is
     *     {@link RecordsManagementInfoType.ApplicationSoftware }
     *     
     */
     ...
     *     
     */
    public void setApplicationSoftware(RecordsManagementInfoType.ApplicationSoftware value) {
        this.applicationSoftware = value;
    }

    public boolean isSetApplicationSoftware() {
        return (this.applicationSoftware!= null);
    }
     ...
     *     
     */
    public void setVitalRecordIndicator(boolean value) {
        this.vitalRecordIndicator = value;
    }

    public boolean isSetVitalRecordIndicator() {
        return (this.vitalRecordIndicator!= null);
    }

    public void unsetVitalRecordIndicator() {
        this.vitalRecordIndicator = null;
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            RecordsManagementInfoType.RecordKeeper theRecordKeeper;
            theRecordKeeper = this.getRecordKeeper();
            strategy.appendField(locator, this, "recordKeeper", buffer, theRecordKeeper, this.isSetRecordKeeper());
        }
        {
            RecordsManagementInfoType.ApplicationSoftware theApplicationSoftware;
            theApplicationSoftware = this.getApplicationSoftware();
            strategy.appendField(locator, this, "applicationSoftware", buffer, theApplicationSoftware, this.isSetApplicationSoftware());
        }
        {
            boolean theVitalRecordIndicator;
            theVitalRecordIndicator = (this.isSetVitalRecordIndicator()?this.getVitalRecordIndicator():false);
            strategy.appendField(locator, this, "vitalRecordIndicator", buffer, theVitalRecordIndicator, this.isSetVitalRecordIndicator());
        }
        return buffer;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final RecordsManagementInfoType that = ((RecordsManagementInfoType) object);
        {
            RecordsManagementInfoType.RecordKeeper lhsRecordKeeper;
            lhsRecordKeeper = this.getRecordKeeper();
            RecordsManagementInfoType.RecordKeeper rhsRecordKeeper;
            rhsRecordKeeper = that.getRecordKeeper();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "recordKeeper", lhsRecordKeeper), LocatorUtils.property(thatLocator, "recordKeeper", rhsRecordKeeper), lhsRecordKeeper, rhsRecordKeeper, this.isSetRecordKeeper(), that.isSetRecordKeeper())) {
                return false;
            }
        }
        {
            RecordsManagementInfoType.ApplicationSoftware lhsApplicationSoftware;
            lhsApplicationSoftware = this.getApplicationSoftware();
            RecordsManagementInfoType.ApplicationSoftware rhsApplicationSoftware;
            rhsApplicationSoftware = that.getApplicationSoftware();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "applicationSoftware", lhsApplicationSoftware), LocatorUtils.property(thatLocator, "applicationSoftware", rhsApplicationSoftware), lhsApplicationSoftware, rhsApplicationSoftware, this.isSetApplicationSoftware(), that.isSetApplicationSoftware())) {
                return false;
            }
        }
        {
            boolean lhsVitalRecordIndicator;
            lhsVitalRecordIndicator = (this.isSetVitalRecordIndicator()?this.getVitalRecordIndicator():false);
            boolean rhsVitalRecordIndicator;
            rhsVitalRecordIndicator = (that.isSetVitalRecordIndicator()?that.getVitalRecordIndicator():false);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "vitalRecordIndicator", lhsVitalRecordIndicator), LocatorUtils.property(thatLocator, "vitalRecordIndicator", rhsVitalRecordIndicator), lhsVitalRecordIndicator, rhsVitalRecordIndicator, this.isSetVitalRecordIndicator(), that.isSetVitalRecordIndicator())) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            RecordsManagementInfoType.RecordKeeper theRecordKeeper;
            theRecordKeeper = this.getRecordKeeper();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "recordKeeper", theRecordKeeper), currentHashCode, theRecordKeeper, this.isSetRecordKeeper());
        }
        {
            RecordsManagementInfoType.ApplicationSoftware theApplicationSoftware;
            theApplicationSoftware = this.getApplicationSoftware();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "applicationSoftware", theApplicationSoftware), currentHashCode, theApplicationSoftware, this.isSetApplicationSoftware());
        }
        {
            boolean theVitalRecordIndicator;
            theVitalRecordIndicator = (this.isSetVitalRecordIndicator()?this.getVitalRecordIndicator():false);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "vitalRecordIndicator", theVitalRecordIndicator), currentHashCode, theVitalRecordIndicator, this.isSetVitalRecordIndicator());
        }
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof RecordsManagementInfoType) {
            final RecordsManagementInfoType copy = ((RecordsManagementInfoType) draftCopy);
            {
                Boolean recordKeeperShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetRecordKeeper());
                if (recordKeeperShouldBeCopiedAndSet == Boolean.TRUE) {
                    RecordsManagementInfoType.RecordKeeper sourceRecordKeeper;
                    sourceRecordKeeper = this.getRecordKeeper();
                    RecordsManagementInfoType.RecordKeeper copyRecordKeeper = ((RecordsManagementInfoType.RecordKeeper) strategy.copy(LocatorUtils.property(locator, "recordKeeper", sourceRecordKeeper), sourceRecordKeeper, this.isSetRecordKeeper()));
                    copy.setRecordKeeper(copyRecordKeeper);
                } else {
                    if (recordKeeperShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.recordKeeper = null;
                    }
                }
            }
            {
                Boolean applicationSoftwareShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetApplicationSoftware());
                if (applicationSoftwareShouldBeCopiedAndSet == Boolean.TRUE) {
                    RecordsManagementInfoType.ApplicationSoftware sourceApplicationSoftware;
                    sourceApplicationSoftware = this.getApplicationSoftware();
                    RecordsManagementInfoType.ApplicationSoftware copyApplicationSoftware = ((RecordsManagementInfoType.ApplicationSoftware) strategy.copy(LocatorUtils.property(locator, "applicationSoftware", sourceApplicationSoftware), sourceApplicationSoftware, this.isSetApplicationSoftware()));
                    copy.setApplicationSoftware(copyApplicationSoftware);
                } else {
                    if (applicationSoftwareShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.applicationSoftware = null;
                    }
                }
            }
            {
                Boolean vitalRecordIndicatorShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetVitalRecordIndicator());
                if (vitalRecordIndicatorShouldBeCopiedAndSet == Boolean.TRUE) {
                    boolean sourceVitalRecordIndicator;
                    sourceVitalRecordIndicator = (this.isSetVitalRecordIndicator()?this.getVitalRecordIndicator():false);
                    boolean copyVitalRecordIndicator = strategy.copy(LocatorUtils.property(locator, "vitalRecordIndicator", sourceVitalRecordIndicator), sourceVitalRecordIndicator, this.isSetVitalRecordIndicator());
                    copy.setVitalRecordIndicator(copyVitalRecordIndicator);
                } else {
                    if (vitalRecordIndicatorShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.unsetVitalRecordIndicator();
                    }
                }
            }
        }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof RecordsManagementInfoType) {
            final RecordsManagementInfoType target = this;
            final RecordsManagementInfoType leftObject = ((RecordsManagementInfoType) left);
            final RecordsManagementInfoType rightObject = ((RecordsManagementInfoType) right);
            {
                Boolean recordKeeperShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetRecordKeeper(), rightObject.isSetRecordKeeper());
                if (recordKeeperShouldBeMergedAndSet == Boolean.TRUE) {
                    RecordsManagementInfoType.RecordKeeper lhsRecordKeeper;
                    lhsRecordKeeper = leftObject.getRecordKeeper();
                    RecordsManagementInfoType.RecordKeeper rhsRecordKeeper;
                    rhsRecordKeeper = rightObject.getRecordKeeper();
                    RecordsManagementInfoType.RecordKeeper mergedRecordKeeper = ((RecordsManagementInfoType.RecordKeeper) strategy.merge(LocatorUtils.property(leftLocator, "recordKeeper", lhsRecordKeeper), LocatorUtils.property(rightLocator, "recordKeeper", rhsRecordKeeper), lhsRecordKeeper, rhsRecordKeeper, leftObject.isSetRecordKeeper(), rightObject.isSetRecordKeeper()));
                    target.setRecordKeeper(mergedRecordKeeper);
                } else {
                    if (recordKeeperShouldBeMergedAndSet == Boolean.FALSE) {
                        target.recordKeeper = null;
                    }
                }
            }
            {
                Boolean applicationSoftwareShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetApplicationSoftware(), rightObject.isSetApplicationSoftware());
                if (applicationSoftwareShouldBeMergedAndSet == Boolean.TRUE) {
                    RecordsManagementInfoType.ApplicationSoftware lhsApplicationSoftware;
                    lhsApplicationSoftware = leftObject.getApplicationSoftware();
                    RecordsManagementInfoType.ApplicationSoftware rhsApplicationSoftware;
                    rhsApplicationSoftware = rightObject.getApplicationSoftware();
                    RecordsManagementInfoType.ApplicationSoftware mergedApplicationSoftware = ((RecordsManagementInfoType.ApplicationSoftware) strategy.merge(LocatorUtils.property(leftLocator, "applicationSoftware", lhsApplicationSoftware), LocatorUtils.property(rightLocator, "applicationSoftware", rhsApplicationSoftware), lhsApplicationSoftware, rhsApplicationSoftware, leftObject.isSetApplicationSoftware(), rightObject.isSetApplicationSoftware()));
                    target.setApplicationSoftware(mergedApplicationSoftware);
                } else {
                    if (applicationSoftwareShouldBeMergedAndSet == Boolean.FALSE) {
                        target.applicationSoftware = null;
                    }
                }
            }
            {
                Boolean vitalRecordIndicatorShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetVitalRecordIndicator(), rightObject.isSetVitalRecordIndicator());
                if (vitalRecordIndicatorShouldBeMergedAndSet == Boolean.TRUE) {
                    boolean lhsVitalRecordIndicator;
                    lhsVitalRecordIndicator = (leftObject.isSetVitalRecordIndicator()?leftObject.getVitalRecordIndicator():false);
                    boolean rhsVitalRecordIndicator;
                    rhsVitalRecordIndicator = (rightObject.isSetVitalRecordIndicator()?rightObject.getVitalRecordIndicator():false);
                    boolean mergedVitalRecordIndicator = ((boolean) strategy.merge(LocatorUtils.property(leftLocator, "vitalRecordIndicator", lhsVitalRecordIndicator), LocatorUtils.property(rightLocator, "vitalRecordIndicator", rhsVitalRecordIndicator), lhsVitalRecordIndicator, rhsVitalRecordIndicator, leftObject.isSetVitalRecordIndicator(), rightObject.isSetVitalRecordIndicator()));
                    target.setVitalRecordIndicator(mergedVitalRecordIndicator);
                } else {
                    if (vitalRecordIndicatorShouldBeMergedAndSet == Boolean.FALSE) {
                        target.unsetVitalRecordIndicator();
                    }
                }
            }
        }
    ...
    public static class ApplicationSoftware implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
    {
        ...
        public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
            ...
            final RecordsManagementInfoType.ApplicationSoftware that = ((RecordsManagementInfoType.ApplicationSoftware) object);
            {
                String lhsValue;
        ...
        public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
            final Object draftCopy = ((target == null)?createNewInstance():target);
            if (draftCopy instanceof RecordsManagementInfoType.ApplicationSoftware) {
                final RecordsManagementInfoType.ApplicationSoftware copy = ((RecordsManagementInfoType.ApplicationSoftware) draftCopy);
                {
        ...
        public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
            if (right instanceof RecordsManagementInfoType.ApplicationSoftware) {
                final RecordsManagementInfoType.ApplicationSoftware target = this;
                final RecordsManagementInfoType.ApplicationSoftware leftObject = ((RecordsManagementInfoType.ApplicationSoftware) left);
                final RecordsManagementInfoType.ApplicationSoftware rightObject = ((RecordsManagementInfoType.ApplicationSoftware) right);
                {
    ...
    public static class RecordKeeper implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
    {

        private final static long serialVersionUID = 1L;
        @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
        @XmlSchemaType(name = "token")
        protected String recordKeeperID;
        protected OrganizationType organization;

        /**
         * Gets the value of the recordKeeperID property.
         * 
         * @return
         *     possible object is
         *     {@link String }
        ...
        /**
         * Sets the value of the recordKeeperID property.
         * 
         * @param value
         *     allowed object is
         *     {@link String }
         *     
         */
        public void setRecordKeeperID(String value) {
            this.recordKeeperID = value;
        }

        public boolean isSetRecordKeeperID() {
            return (this.recordKeeperID!= null);
        }
        ...
        public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
            {
                String theRecordKeeperID;
                theRecordKeeperID = this.getRecordKeeperID();
                strategy.appendField(locator, this, "recordKeeperID", buffer, theRecordKeeperID, this.isSetRecordKeeperID());
            }
            {
        ...
        public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
            ...
            final RecordsManagementInfoType.RecordKeeper that = ((RecordsManagementInfoType.RecordKeeper) object);
            {
                String lhsRecordKeeperID;
                lhsRecordKeeperID = this.getRecordKeeperID();
                String rhsRecordKeeperID;
                rhsRecordKeeperID = that.getRecordKeeperID();
                if (!strategy.equals(LocatorUtils.property(thisLocator, "recordKeeperID", lhsRecordKeeperID), LocatorUtils.property(thatLocator, "recordKeeperID", rhsRecordKeeperID), lhsRecordKeeperID, rhsRecordKeeperID, this.isSetRecordKeeperID(), that.isSetRecordKeeperID())) {
                    return false;
                }
            }
            {
        ...
        public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
            int currentHashCode = 1;
            {
                String theRecordKeeperID;
                theRecordKeeperID = this.getRecordKeeperID();
                currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "recordKeeperID", theRecordKeeperID), currentHashCode, theRecordKeeperID, this.isSetRecordKeeperID());
            }
            {
                OrganizationType theOrganization;
                theOrganization = this.getOrganization();
        ...
        public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
            final Object draftCopy = ((target == null)?createNewInstance():target);
            if (draftCopy instanceof RecordsManagementInfoType.RecordKeeper) {
                final RecordsManagementInfoType.RecordKeeper copy = ((RecordsManagementInfoType.RecordKeeper) draftCopy);
                {
                    Boolean recordKeeperIDShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetRecordKeeperID());
                    if (recordKeeperIDShouldBeCopiedAndSet == Boolean.TRUE) {
                        String sourceRecordKeeperID;
                        sourceRecordKeeperID = this.getRecordKeeperID();
                        String copyRecordKeeperID = ((String) strategy.copy(LocatorUtils.property(locator, "recordKeeperID", sourceRecordKeeperID), sourceRecordKeeperID, this.isSetRecordKeeperID()));
                        copy.setRecordKeeperID(copyRecordKeeperID);
                    } else {
                        if (recordKeeperIDShouldBeCopiedAndSet == Boolean.FALSE) {
                            copy.recordKeeperID = null;
                        }
                    }
                }
                {
        ...
        public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
            if (right instanceof RecordsManagementInfoType.RecordKeeper) {
                final RecordsManagementInfoType.RecordKeeper target = this;
                final RecordsManagementInfoType.RecordKeeper leftObject = ((RecordsManagementInfoType.RecordKeeper) left);
                final RecordsManagementInfoType.RecordKeeper rightObject = ((RecordsManagementInfoType.RecordKeeper) right);
                {
                    Boolean recordKeeperIDShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetRecordKeeperID(), rightObject.isSetRecordKeeperID());
                    if (recordKeeperIDShouldBeMergedAndSet == Boolean.TRUE) {
                        String lhsRecordKeeperID;
                        lhsRecordKeeperID = leftObject.getRecordKeeperID();
                        String rhsRecordKeeperID;
                        rhsRecordKeeperID = rightObject.getRecordKeeperID();
                        String mergedRecordKeeperID = ((String) strategy.merge(LocatorUtils.property(leftLocator, "recordKeeperID", lhsRecordKeeperID), LocatorUtils.property(rightLocator, "recordKeeperID", rhsRecordKeeperID), lhsRecordKeeperID, rhsRecordKeeperID, leftObject.isSetRecordKeeperID(), rightObject.isSetRecordKeeperID()));
                        target.setRecordKeeperID(mergedRecordKeeperID);
                    } else {
                        if (recordKeeperIDShouldBeMergedAndSet == Boolean.FALSE) {
                            target.recordKeeperID = null;
                        }
                    }
                }
                {
