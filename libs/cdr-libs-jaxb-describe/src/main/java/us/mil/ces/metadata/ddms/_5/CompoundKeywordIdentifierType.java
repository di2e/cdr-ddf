...
/**
 * <p>Java class for CompoundKeywordIdentifierType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CompoundKeywordIdentifierType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "CompoundKeywordIdentifierType")
public class CompoundKeywordIdentifierType implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{

    private final static long serialVersionUID = 1L;
    @XmlAttribute(name = "value", namespace = "urn:us:mil:ces:metadata:ddms:5", required = true)
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @NotNull(message = "CompoundKeywordIdentifierType.value {javax.validation.constraints.NotNull.message}")
    @Size(min = 1)
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final CompoundKeywordIdentifierType that = ((CompoundKeywordIdentifierType) object);
        {
            String lhsValue;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof CompoundKeywordIdentifierType) {
            final CompoundKeywordIdentifierType copy = ((CompoundKeywordIdentifierType) draftCopy);
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof CompoundKeywordIdentifierType) {
            final CompoundKeywordIdentifierType target = this;
            final CompoundKeywordIdentifierType leftObject = ((CompoundKeywordIdentifierType) left);
            final CompoundKeywordIdentifierType rightObject = ((CompoundKeywordIdentifierType) right);
            {
