...
/**
 * <p>Java class for CompoundResourceIdentifierType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CompoundResourceIdentifierType"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;attribute name="qualifier" use="required" type="{http://www.w3.org/2001/XMLSchema}anyURI" /&gt;
 *       &lt;attribute name="value" use="required" type="{urn:us:mil:ces:metadata:ddms:5}simpleTokenType" /&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
@XmlType(name = "CompoundResourceIdentifierType")
@XmlSeeAlso({
    RelatedResourcesType.class
})
public class CompoundResourceIdentifierType implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{

    private final static long serialVersionUID = 1L;
    @XmlAttribute(name = "qualifier", namespace = "urn:us:mil:ces:metadata:ddms:5", required = true)
    @XmlSchemaType(name = "anyURI")
    @NotNull(message = "CompoundResourceIdentifierType.qualifier {javax.validation.constraints.NotNull.message}")
    protected String qualifier;
    @XmlAttribute(name = "value", namespace = "urn:us:mil:ces:metadata:ddms:5", required = true)
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @NotNull(message = "CompoundResourceIdentifierType.value {javax.validation.constraints.NotNull.message}")
    @Size(min = 1)
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final CompoundResourceIdentifierType that = ((CompoundResourceIdentifierType) object);
        {
            String lhsQualifier;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof CompoundResourceIdentifierType) {
            final CompoundResourceIdentifierType copy = ((CompoundResourceIdentifierType) draftCopy);
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof CompoundResourceIdentifierType) {
            final CompoundResourceIdentifierType target = this;
            final CompoundResourceIdentifierType leftObject = ((CompoundResourceIdentifierType) left);
            final CompoundResourceIdentifierType rightObject = ((CompoundResourceIdentifierType) right);
            {
