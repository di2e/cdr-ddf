...
/**
 * <p>Java class for RevisionRecallType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="RevisionRecallType"&gt;
 *   &lt;complexContent&gt;
 ...
 *       &lt;/sequence&gt;
 *       &lt;attGroup ref="{urn:us:mil:ces:metadata:ddms:5}SecurityAttributesGroup"/&gt;
 *       &lt;attGroup ref="{urn:us:mil:ces:metadata:ddms:5}OptionalResourceLinkAttributesGroup"/&gt;
 *       &lt;attribute name="revisionID" use="required" type="{http://www.w3.org/2001/XMLSchema}int" /&gt;
 *       &lt;attribute name="revisionType" use="required"&gt;
 *         &lt;simpleType&gt;
 *           &lt;restriction base="{http://www.w3.org/2001/XMLSchema}string"&gt;
 *             &lt;enumeration value="ADMINISTRATIVE RECALL"/&gt;
 *             &lt;enumeration value="ADMINISTRATIVE REVISION"/&gt;
 *             &lt;enumeration value="SUBSTANTIVE RECALL"/&gt;
 *             &lt;enumeration value="SUBSTANTIVE REVISION"/&gt;
 *           &lt;/restriction&gt;
 *         &lt;/simpleType&gt;
 *       &lt;/attribute&gt;
 *     &lt;/restriction&gt;
...
@XmlType(name = "RevisionRecallType", propOrder = {
    "content"
})
public class RevisionRecallType implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{

    private final static long serialVersionUID = 1L;
    @XmlElementRefs({
        @XmlElementRef(name = "link", namespace = "urn:us:mil:ces:metadata:ddms:5", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "details", namespace = "urn:us:mil:ces:metadata:ddms:5", type = JAXBElement.class, required = false)
    })
    @XmlMixed
    protected List<Serializable> content;
    @XmlAttribute(name = "revisionID", namespace = "urn:us:mil:ces:metadata:ddms:5", required = true)
    @NotNull(message = "RevisionRecallType.revisionID {javax.validation.constraints.NotNull.message}")
    protected int revisionID;
    @XmlAttribute(name = "revisionType", namespace = "urn:us:mil:ces:metadata:ddms:5", required = true)
    @NotNull(message = "RevisionRecallType.revisionType {javax.validation.constraints.NotNull.message}")
    @Pattern(regexp = "(ADMINISTRATIVE RECALL)|(ADMINISTRATIVE REVISION)|(SUBSTANTIVE RECALL)|(SUBSTANTIVE REVISION)")
    protected String revisionType;
    @XmlAttribute(name = "classification", namespace = "urn:us:gov:ic:ism", required = true)
    @NotNull(message = "RevisionRecallType.classification {javax.validation.constraints.NotNull.message}")
    ...
    @NotNull(message = "RevisionRecallType.ownerProducer {javax.validation.constraints.NotNull.message}")
     ...
     * {@link JAXBElement }{@code <}{@link RevisionRecallType.Details }{@code >}
     * {@link String }
     * {@link JAXBElement }{@code <}{@link RevisionRecallType.Link }{@code >}
     * 
     * 
     */
     ...
     * @return
     *     possible object is
     *     {@link org.hisrc.w3c.xlink.v_1_0.TypeType }
     *     
     */
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        {
            int theRevisionID;
            theRevisionID = this.getRevisionID();
            strategy.appendField(locator, this, "revisionID", buffer, theRevisionID, true);
        }
        {
            String theRevisionType;
            theRevisionType = this.getRevisionType();
            strategy.appendField(locator, this, "revisionType", buffer, theRevisionType, this.isSetRevisionType());
        }
        {
        ...
        {
            org.hisrc.w3c.xlink.v_1_0.TypeType theType;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final RevisionRecallType that = ((RevisionRecallType) object);
        {
        ...
        {
            int lhsRevisionID;
            lhsRevisionID = this.getRevisionID();
            int rhsRevisionID;
            rhsRevisionID = that.getRevisionID();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "revisionID", lhsRevisionID), LocatorUtils.property(thatLocator, "revisionID", rhsRevisionID), lhsRevisionID, rhsRevisionID, true, true)) {
                return false;
            }
        }
        {
            String lhsRevisionType;
            lhsRevisionType = this.getRevisionType();
            String rhsRevisionType;
            rhsRevisionType = that.getRevisionType();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "revisionType", lhsRevisionType), LocatorUtils.property(thatLocator, "revisionType", rhsRevisionType), lhsRevisionType, rhsRevisionType, this.isSetRevisionType(), that.isSetRevisionType())) {
                return false;
            }
        }
        {
        ...
        {
            org.hisrc.w3c.xlink.v_1_0.TypeType lhsType;
            lhsType = this.getType();
            org.hisrc.w3c.xlink.v_1_0.TypeType rhsType;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        }
        {
            int theRevisionID;
            theRevisionID = this.getRevisionID();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "revisionID", theRevisionID), currentHashCode, theRevisionID, true);
        }
        {
            String theRevisionType;
            theRevisionType = this.getRevisionType();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "revisionType", theRevisionType), currentHashCode, theRevisionType, this.isSetRevisionType());
        }
        {
            CVEnumISMClassificationAll theClassification;
            theClassification = this.getClassification();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof RevisionRecallType) {
            final RevisionRecallType copy = ((RevisionRecallType) draftCopy);
            {
            ...
            {
                Boolean revisionIDShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, true);
                if (revisionIDShouldBeCopiedAndSet == Boolean.TRUE) {
                    int sourceRevisionID;
                    sourceRevisionID = this.getRevisionID();
                    int copyRevisionID = strategy.copy(LocatorUtils.property(locator, "revisionID", sourceRevisionID), sourceRevisionID, true);
                    copy.setRevisionID(copyRevisionID);
                } else {
                    if (revisionIDShouldBeCopiedAndSet == Boolean.FALSE) {
                    }
                }
            }
            {
                Boolean revisionTypeShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetRevisionType());
                if (revisionTypeShouldBeCopiedAndSet == Boolean.TRUE) {
                    String sourceRevisionType;
                    sourceRevisionType = this.getRevisionType();
                    String copyRevisionType = ((String) strategy.copy(LocatorUtils.property(locator, "revisionType", sourceRevisionType), sourceRevisionType, this.isSetRevisionType()));
                    copy.setRevisionType(copyRevisionType);
                } else {
                    if (revisionTypeShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.revisionType = null;
                    }
                }
            }
            {
            ...
            }
            {
                ...
                if (typeShouldBeCopiedAndSet == Boolean.TRUE) {
                    org.hisrc.w3c.xlink.v_1_0.TypeType sourceType;
                    sourceType = this.getType();
                    org.hisrc.w3c.xlink.v_1_0.TypeType copyType = ((org.hisrc.w3c.xlink.v_1_0.TypeType) strategy.copy(LocatorUtils.property(locator, "type", sourceType), sourceType, this.isSetType()));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof RevisionRecallType) {
            final RevisionRecallType target = this;
            final RevisionRecallType leftObject = ((RevisionRecallType) left);
            final RevisionRecallType rightObject = ((RevisionRecallType) right);
            {
            ...
            {
                Boolean revisionIDShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, true, true);
                if (revisionIDShouldBeMergedAndSet == Boolean.TRUE) {
                    int lhsRevisionID;
                    lhsRevisionID = leftObject.getRevisionID();
                    int rhsRevisionID;
                    rhsRevisionID = rightObject.getRevisionID();
                    int mergedRevisionID = ((int) strategy.merge(LocatorUtils.property(leftLocator, "revisionID", lhsRevisionID), LocatorUtils.property(rightLocator, "revisionID", rhsRevisionID), lhsRevisionID, rhsRevisionID, true, true));
                    target.setRevisionID(mergedRevisionID);
                } else {
                    if (revisionIDShouldBeMergedAndSet == Boolean.FALSE) {
                    }
                }
            }
            {
                Boolean revisionTypeShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetRevisionType(), rightObject.isSetRevisionType());
                if (revisionTypeShouldBeMergedAndSet == Boolean.TRUE) {
                    String lhsRevisionType;
                    lhsRevisionType = leftObject.getRevisionType();
                    String rhsRevisionType;
                    rhsRevisionType = rightObject.getRevisionType();
                    String mergedRevisionType = ((String) strategy.merge(LocatorUtils.property(leftLocator, "revisionType", lhsRevisionType), LocatorUtils.property(rightLocator, "revisionType", rhsRevisionType), lhsRevisionType, rhsRevisionType, leftObject.isSetRevisionType(), rightObject.isSetRevisionType()));
                    target.setRevisionType(mergedRevisionType);
                } else {
                    if (revisionTypeShouldBeMergedAndSet == Boolean.FALSE) {
                        target.revisionType = null;
                    }
                }
            }
            {
            ...
            }
            {
                ...
                if (typeShouldBeMergedAndSet == Boolean.TRUE) {
                    ...
                    org.hisrc.w3c.xlink.v_1_0.TypeType mergedType = ((org.hisrc.w3c.xlink.v_1_0.TypeType) strategy.merge(LocatorUtils.property(leftLocator, "type", lhsType), LocatorUtils.property(rightLocator, "type", rhsType), lhsType, rhsType, leftObject.isSetType(), rightObject.isSetType()));
    ...
    public static class Details implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
    {
        ...
        public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
            ...
            final RevisionRecallType.Details that = ((RevisionRecallType.Details) object);
            {
                String lhsValue;
        ...
        public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
            final Object draftCopy = ((target == null)?createNewInstance():target);
            if (draftCopy instanceof RevisionRecallType.Details) {
                final RevisionRecallType.Details copy = ((RevisionRecallType.Details) draftCopy);
                {
        ...
        public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
            if (right instanceof RevisionRecallType.Details) {
                final RevisionRecallType.Details target = this;
                final RevisionRecallType.Details leftObject = ((RevisionRecallType.Details) left);
                final RevisionRecallType.Details rightObject = ((RevisionRecallType.Details) right);
                {
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class Link implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
    {
        ...
        public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
            ...
            final RevisionRecallType.Link that = ((RevisionRecallType.Link) object);
            {
                org.hisrc.w3c.xlink.v_1_0.TypeType lhsType;
                lhsType = this.getType();
                org.hisrc.w3c.xlink.v_1_0.TypeType rhsType;
        ...
        public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
            final Object draftCopy = ((target == null)?createNewInstance():target);
            if (draftCopy instanceof RevisionRecallType.Link) {
                final RevisionRecallType.Link copy = ((RevisionRecallType.Link) draftCopy);
                {
                    Boolean typeShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetType());
                    if (typeShouldBeCopiedAndSet == Boolean.TRUE) {
                        org.hisrc.w3c.xlink.v_1_0.TypeType sourceType;
        ...
        public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
            if (right instanceof RevisionRecallType.Link) {
                final RevisionRecallType.Link target = this;
                final RevisionRecallType.Link leftObject = ((RevisionRecallType.Link) left);
                final RevisionRecallType.Link rightObject = ((RevisionRecallType.Link) right);
                {
                    Boolean typeShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetType(), rightObject.isSetType());
                    if (typeShouldBeMergedAndSet == Boolean.TRUE) {
                        org.hisrc.w3c.xlink.v_1_0.TypeType lhsType;
