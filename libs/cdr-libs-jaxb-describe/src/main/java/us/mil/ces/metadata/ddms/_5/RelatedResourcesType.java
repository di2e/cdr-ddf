...
/**
 * <p>Java class for RelatedResourcesType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="RelatedResourcesType"&gt;
 *   &lt;complexContent&gt;
 *     &lt;extension base="{urn:us:mil:ces:metadata:ddms:5}CompoundResourceIdentifierType"&gt;
 *       &lt;sequence&gt;
 ...
 *       &lt;attribute name="relationship" use="required" type="{http://www.w3.org/2001/XMLSchema}anyURI" /&gt;
 *       &lt;attribute name="direction" default="outbound"&gt;
 *         &lt;simpleType&gt;
...
@XmlType(name = "RelatedResourcesType", propOrder = {
    "link"
})
public class RelatedResourcesType
    extends CompoundResourceIdentifierType
    implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{

    private final static long serialVersionUID = 1L;
    @XmlElement(required = true)
    @NotNull(message = "RelatedResourcesType.link {javax.validation.constraints.NotNull.message}")
    @Size(min = 1)
    @Valid
    protected List<RelatedResourcesType.Link> link;
    @XmlAttribute(name = "relationship", namespace = "urn:us:mil:ces:metadata:ddms:5", required = true)
    @XmlSchemaType(name = "anyURI")
    @NotNull(message = "RelatedResourcesType.relationship {javax.validation.constraints.NotNull.message}")
    protected String relationship;
    @XmlAttribute(name = "direction", namespace = "urn:us:mil:ces:metadata:ddms:5")
    @Pattern(regexp = "(inbound)|(outbound)|(bidirectional)")
     ...
     * {@link RelatedResourcesType.Link }
     * 
     * 
     */
    public List<RelatedResourcesType.Link> getLink() {
        if (link == null) {
            link = new ArrayList<RelatedResourcesType.Link>();
        }
        return this.link;
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        {
            List<RelatedResourcesType.Link> theLink;
            theLink = (this.isSetLink()?this.getLink():null);
        ...
        }
        {
            ...
            strategy.appendField(locator, this, "relationship", buffer, theRelationship, this.isSetRelationship());
        }
        {
            String theDirection;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final RelatedResourcesType that = ((RelatedResourcesType) object);
        {
            List<RelatedResourcesType.Link> lhsLink;
            lhsLink = (this.isSetLink()?this.getLink():null);
            List<RelatedResourcesType.Link> rhsLink;
            rhsLink = (that.isSetLink()?that.getLink():null);
        ...
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "relationship", lhsRelationship), LocatorUtils.property(thatLocator, "relationship", rhsRelationship), lhsRelationship, rhsRelationship, this.isSetRelationship(), that.isSetRelationship())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        }
        {
            String theRelationship;
            theRelationship = this.getRelationship();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "relationship", theRelationship), currentHashCode, theRelationship, this.isSetRelationship());
        }
        {
            String theDirection;
            theDirection = this.getDirection();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof RelatedResourcesType) {
            final RelatedResourcesType copy = ((RelatedResourcesType) draftCopy);
            {
                ...
                if (linkShouldBeCopiedAndSet == Boolean.TRUE) {
                    List<RelatedResourcesType.Link> sourceLink;
                    sourceLink = (this.isSetLink()?this.getLink():null);
                    @SuppressWarnings("unchecked")
                    List<RelatedResourcesType.Link> copyLink = ((List<RelatedResourcesType.Link> ) strategy.copy(LocatorUtils.property(locator, "link", sourceLink), sourceLink, this.isSetLink()));
                    copy.unsetLink();
                    if (copyLink!= null) {
                        List<RelatedResourcesType.Link> uniqueLinkl = copy.getLink();
            ...
            {
                Boolean relationshipShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetRelationship());
                if (relationshipShouldBeCopiedAndSet == Boolean.TRUE) {
                    String sourceRelationship;
                    sourceRelationship = this.getRelationship();
                    String copyRelationship = ((String) strategy.copy(LocatorUtils.property(locator, "relationship", sourceRelationship), sourceRelationship, this.isSetRelationship()));
                    copy.setRelationship(copyRelationship);
                } else {
                    if (relationshipShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.relationship = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        ...
        if (right instanceof RelatedResourcesType) {
            final RelatedResourcesType target = this;
            final RelatedResourcesType leftObject = ((RelatedResourcesType) left);
            final RelatedResourcesType rightObject = ((RelatedResourcesType) right);
            {
                ...
                if (linkShouldBeMergedAndSet == Boolean.TRUE) {
                    List<RelatedResourcesType.Link> lhsLink;
                    lhsLink = (leftObject.isSetLink()?leftObject.getLink():null);
                    List<RelatedResourcesType.Link> rhsLink;
                    rhsLink = (rightObject.isSetLink()?rightObject.getLink():null);
                    List<RelatedResourcesType.Link> mergedLink = ((List<RelatedResourcesType.Link> ) strategy.merge(LocatorUtils.property(leftLocator, "link", lhsLink), LocatorUtils.property(rightLocator, "link", rhsLink), lhsLink, rhsLink, leftObject.isSetLink(), rightObject.isSetLink()));
                    target.unsetLink();
                    if (mergedLink!= null) {
                        List<RelatedResourcesType.Link> uniqueLinkl = target.getLink();
            ...
            {
                Boolean relationshipShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetRelationship(), rightObject.isSetRelationship());
                if (relationshipShouldBeMergedAndSet == Boolean.TRUE) {
                    String lhsRelationship;
                    lhsRelationship = leftObject.getRelationship();
                    String rhsRelationship;
                    rhsRelationship = rightObject.getRelationship();
                    String mergedRelationship = ((String) strategy.merge(LocatorUtils.property(leftLocator, "relationship", lhsRelationship), LocatorUtils.property(rightLocator, "relationship", rhsRelationship), lhsRelationship, rhsRelationship, leftObject.isSetRelationship(), rightObject.isSetRelationship()));
                    target.setRelationship(mergedRelationship);
                } else {
                    if (relationshipShouldBeMergedAndSet == Boolean.FALSE) {
    ...
    public void setLink(List<RelatedResourcesType.Link> value) {
        this.link = null;
        if (value!= null) {
            List<RelatedResourcesType.Link> draftl = this.getLink();
            draftl.addAll(value);
        }
    }
    ...
    public static class Link implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
    {
        ...
        public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
            ...
            final RelatedResourcesType.Link that = ((RelatedResourcesType.Link) object);
            {
                TypeType lhsType;
        ...
        public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
            final Object draftCopy = ((target == null)?createNewInstance():target);
            if (draftCopy instanceof RelatedResourcesType.Link) {
                final RelatedResourcesType.Link copy = ((RelatedResourcesType.Link) draftCopy);
                {
        ...
        public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
            if (right instanceof RelatedResourcesType.Link) {
                final RelatedResourcesType.Link target = this;
                final RelatedResourcesType.Link leftObject = ((RelatedResourcesType.Link) left);
                final RelatedResourcesType.Link rightObject = ((RelatedResourcesType.Link) right);
                {
