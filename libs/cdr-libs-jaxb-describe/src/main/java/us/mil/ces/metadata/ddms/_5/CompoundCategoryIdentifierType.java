...
/**
 * <p>Java class for CompoundCategoryIdentifierType complex type.
 * 
...
@XmlType(name = "CompoundCategoryIdentifierType")
public class CompoundCategoryIdentifierType implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    @XmlAttribute(name = "code", namespace = "urn:us:mil:ces:metadata:ddms:5")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @Size(min = 1)
    protected String code;
    @XmlAttribute(name = "label", namespace = "urn:us:mil:ces:metadata:ddms:5", required = true)
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final CompoundCategoryIdentifierType that = ((CompoundCategoryIdentifierType) object);
        {
            String lhsQualifier;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof CompoundCategoryIdentifierType) {
            final CompoundCategoryIdentifierType copy = ((CompoundCategoryIdentifierType) draftCopy);
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof CompoundCategoryIdentifierType) {
            final CompoundCategoryIdentifierType target = this;
            final CompoundCategoryIdentifierType leftObject = ((CompoundCategoryIdentifierType) left);
            final CompoundCategoryIdentifierType rightObject = ((CompoundCategoryIdentifierType) right);
            {
