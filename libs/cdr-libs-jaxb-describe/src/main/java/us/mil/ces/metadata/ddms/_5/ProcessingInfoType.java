...
/**
 * <p>Java class for ProcessingInfoType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ProcessingInfoType"&gt;
 *   &lt;simpleContent&gt;
 ...
 *       &lt;attribute name="dateProcessed" use="required" type="{urn:us:mil:ces:metadata:ddms:5}CombinedDateType" /&gt;
 *     &lt;/extension&gt;
 *   &lt;/simpleContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
@XmlType(name = "ProcessingInfoType", propOrder = {
    "value"
})
public class ProcessingInfoType implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    @XmlAttribute(name = "dateProcessed", namespace = "urn:us:mil:ces:metadata:ddms:5", required = true)
    @NotNull(message = "ProcessingInfoType.dateProcessed {javax.validation.constraints.NotNull.message}")
    protected String dateProcessed;
    @XmlAttribute(name = "classification", namespace = "urn:us:gov:ic:ism", required = true)
    @NotNull(message = "ProcessingInfoType.classification {javax.validation.constraints.NotNull.message}")
    ...
    @NotNull(message = "ProcessingInfoType.ownerProducer {javax.validation.constraints.NotNull.message}")
    ...
    public boolean isSetDateProcessed() {
        return (this.dateProcessed!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        {
            String theDateProcessed;
            theDateProcessed = this.getDateProcessed();
            strategy.appendField(locator, this, "dateProcessed", buffer, theDateProcessed, this.isSetDateProcessed());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ProcessingInfoType that = ((ProcessingInfoType) object);
        {
            String lhsValue;
        ...
        {
            String lhsDateProcessed;
            lhsDateProcessed = this.getDateProcessed();
            String rhsDateProcessed;
            rhsDateProcessed = that.getDateProcessed();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "dateProcessed", lhsDateProcessed), LocatorUtils.property(thatLocator, "dateProcessed", rhsDateProcessed), lhsDateProcessed, rhsDateProcessed, this.isSetDateProcessed(), that.isSetDateProcessed())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        }
        {
            String theDateProcessed;
            theDateProcessed = this.getDateProcessed();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "dateProcessed", theDateProcessed), currentHashCode, theDateProcessed, this.isSetDateProcessed());
        }
        {
            CVEnumISMClassificationAll theClassification;
            theClassification = this.getClassification();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof ProcessingInfoType) {
            final ProcessingInfoType copy = ((ProcessingInfoType) draftCopy);
            {
            ...
            {
                Boolean dateProcessedShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetDateProcessed());
                if (dateProcessedShouldBeCopiedAndSet == Boolean.TRUE) {
                    String sourceDateProcessed;
                    sourceDateProcessed = this.getDateProcessed();
                    String copyDateProcessed = ((String) strategy.copy(LocatorUtils.property(locator, "dateProcessed", sourceDateProcessed), sourceDateProcessed, this.isSetDateProcessed()));
                    copy.setDateProcessed(copyDateProcessed);
                } else {
                    if (dateProcessedShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.dateProcessed = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof ProcessingInfoType) {
            final ProcessingInfoType target = this;
            final ProcessingInfoType leftObject = ((ProcessingInfoType) left);
            final ProcessingInfoType rightObject = ((ProcessingInfoType) right);
            {
            ...
            {
                Boolean dateProcessedShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetDateProcessed(), rightObject.isSetDateProcessed());
                if (dateProcessedShouldBeMergedAndSet == Boolean.TRUE) {
                    String lhsDateProcessed;
                    lhsDateProcessed = leftObject.getDateProcessed();
                    String rhsDateProcessed;
                    rhsDateProcessed = rightObject.getDateProcessed();
                    String mergedDateProcessed = ((String) strategy.merge(LocatorUtils.property(leftLocator, "dateProcessed", lhsDateProcessed), LocatorUtils.property(rightLocator, "dateProcessed", rhsDateProcessed), lhsDateProcessed, rhsDateProcessed, leftObject.isSetDateProcessed(), rightObject.isSetDateProcessed()));
                    target.setDateProcessed(mergedDateProcessed);
                } else {
                    if (dateProcessedShouldBeMergedAndSet == Boolean.FALSE) {
                        target.dateProcessed = null;
                    }
                }
            }
            {
