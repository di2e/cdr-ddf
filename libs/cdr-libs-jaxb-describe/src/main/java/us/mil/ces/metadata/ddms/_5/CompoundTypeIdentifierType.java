...
// Generated on: 2016.08.02 at 09:37:42 PM EDT 
//
...
/**
 * <p>Java class for CompoundTypeIdentifierType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CompoundTypeIdentifierType"&gt;
 *   &lt;simpleContent&gt;
...
@XmlType(name = "CompoundTypeIdentifierType", propOrder = {
    "elementValue"
})
public class CompoundTypeIdentifierType implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            String theValue;
            theValue = this.getElementValue();
            strategy.appendField(locator, this, "elementValue", buffer, theValue, this.isSetValue());
        }
        {
            String theQualifier;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final CompoundTypeIdentifierType that = ((CompoundTypeIdentifierType) object);
        {
            String lhsValue;
            lhsValue = this.getElementValue();
            String rhsValue;
            rhsValue = that.getElementValue();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "elementValue", lhsValue), LocatorUtils.property(thatLocator, "elementValue", rhsValue), lhsValue, rhsValue, this.isSetValue(), that.isSetValue())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            String theValue;
            theValue = this.getElementValue();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "elementValue", theValue), currentHashCode, theValue, this.isSetValue());
        }
        {
            String theQualifier;
            theQualifier = this.getQualifier();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof CompoundTypeIdentifierType) {
            final CompoundTypeIdentifierType copy = ((CompoundTypeIdentifierType) draftCopy);
            {
                Boolean valueShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetValue());
                if (valueShouldBeCopiedAndSet == Boolean.TRUE) {
                    String sourceValue;
                    sourceValue = this.getElementValue();
                    String copyValue = ((String) strategy.copy(LocatorUtils.property(locator, "elementValue", sourceValue), sourceValue, this.isSetValue()));
                    copy.setElementValue(copyValue);
                } else {
                    if (valueShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.elementValue = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof CompoundTypeIdentifierType) {
            final CompoundTypeIdentifierType target = this;
            final CompoundTypeIdentifierType leftObject = ((CompoundTypeIdentifierType) left);
            final CompoundTypeIdentifierType rightObject = ((CompoundTypeIdentifierType) right);
            {
                ...
                if (valueShouldBeMergedAndSet == Boolean.TRUE) {
                    String lhsValue;
                    lhsValue = leftObject.getElementValue();
                    String rhsValue;
                    rhsValue = rightObject.getElementValue();
                    String mergedValue = ((String) strategy.merge(LocatorUtils.property(leftLocator, "elementValue", lhsValue), LocatorUtils.property(rightLocator, "elementValue", rhsValue), lhsValue, rhsValue, leftObject.isSetValue(), rightObject.isSetValue()));
                    target.setElementValue(mergedValue);
                } else {
                    if (valueShouldBeMergedAndSet == Boolean.FALSE) {
                        target.elementValue = null;
                    }
                }
            }
            {
