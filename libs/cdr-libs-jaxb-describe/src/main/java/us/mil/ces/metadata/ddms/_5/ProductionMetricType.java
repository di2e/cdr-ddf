...
/**
 * <p>Java class for ProductionMetricType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ProductionMetricType"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;attGroup ref="{urn:us:mil:ces:metadata:ddms:5}SecurityAttributesOptionGroup"/&gt;
 *       &lt;attribute name="subject" use="required" type="{urn:us:mil:ces:metadata:ddms:5}simpleTokenType" /&gt;
 *       &lt;attribute name="coverage" use="required" type="{urn:us:mil:ces:metadata:ddms:5}simpleTokenType" /&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
@XmlType(name = "ProductionMetricType")
public class ProductionMetricType implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{

    private final static long serialVersionUID = 1L;
    @XmlAttribute(name = "subject", namespace = "urn:us:mil:ces:metadata:ddms:5", required = true)
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @NotNull(message = "ProductionMetricType.subject {javax.validation.constraints.NotNull.message}")
    @Size(min = 1)
    protected String subject;
    @XmlAttribute(name = "coverage", namespace = "urn:us:mil:ces:metadata:ddms:5", required = true)
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @NotNull(message = "ProductionMetricType.coverage {javax.validation.constraints.NotNull.message}")
    @Size(min = 1)
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "subject", buffer, theSubject, this.isSetSubject());
        }
        {
            String theCoverage;
            theCoverage = this.getCoverage();
            strategy.appendField(locator, this, "coverage", buffer, theCoverage, this.isSetCoverage());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ProductionMetricType that = ((ProductionMetricType) object);
        {
            String lhsSubject;
            lhsSubject = this.getSubject();
            String rhsSubject;
            rhsSubject = that.getSubject();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "subject", lhsSubject), LocatorUtils.property(thatLocator, "subject", rhsSubject), lhsSubject, rhsSubject, this.isSetSubject(), that.isSetSubject())) {
                return false;
            }
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "coverage", lhsCoverage), LocatorUtils.property(thatLocator, "coverage", rhsCoverage), lhsCoverage, rhsCoverage, this.isSetCoverage(), that.isSetCoverage())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            String theSubject;
            theSubject = this.getSubject();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "subject", theSubject), currentHashCode, theSubject, this.isSetSubject());
        }
        {
            String theCoverage;
            theCoverage = this.getCoverage();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "coverage", theCoverage), currentHashCode, theCoverage, this.isSetCoverage());
        }
        {
            CVEnumISMClassificationAll theClassification;
            theClassification = this.getClassification();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof ProductionMetricType) {
            final ProductionMetricType copy = ((ProductionMetricType) draftCopy);
            {
                Boolean subjectShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetSubject());
                if (subjectShouldBeCopiedAndSet == Boolean.TRUE) {
                    String sourceSubject;
                    sourceSubject = this.getSubject();
                    String copySubject = ((String) strategy.copy(LocatorUtils.property(locator, "subject", sourceSubject), sourceSubject, this.isSetSubject()));
                    copy.setSubject(copySubject);
                } else {
                    if (subjectShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.subject = null;
                    }
                }
            }
            {
                Boolean coverageShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetCoverage());
                if (coverageShouldBeCopiedAndSet == Boolean.TRUE) {
                    String sourceCoverage;
                    sourceCoverage = this.getCoverage();
                    String copyCoverage = ((String) strategy.copy(LocatorUtils.property(locator, "coverage", sourceCoverage), sourceCoverage, this.isSetCoverage()));
                    copy.setCoverage(copyCoverage);
                } else {
                    if (coverageShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.coverage = null;
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof ProductionMetricType) {
            final ProductionMetricType target = this;
            final ProductionMetricType leftObject = ((ProductionMetricType) left);
            final ProductionMetricType rightObject = ((ProductionMetricType) right);
            {
                Boolean subjectShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetSubject(), rightObject.isSetSubject());
                if (subjectShouldBeMergedAndSet == Boolean.TRUE) {
                    String lhsSubject;
                    lhsSubject = leftObject.getSubject();
                    String rhsSubject;
                    rhsSubject = rightObject.getSubject();
                    String mergedSubject = ((String) strategy.merge(LocatorUtils.property(leftLocator, "subject", lhsSubject), LocatorUtils.property(rightLocator, "subject", rhsSubject), lhsSubject, rhsSubject, leftObject.isSetSubject(), rightObject.isSetSubject()));
                    target.setSubject(mergedSubject);
                } else {
                    if (subjectShouldBeMergedAndSet == Boolean.FALSE) {
                        target.subject = null;
                    }
                }
            }
            {
                Boolean coverageShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetCoverage(), rightObject.isSetCoverage());
                if (coverageShouldBeMergedAndSet == Boolean.TRUE) {
                    String lhsCoverage;
                    lhsCoverage = leftObject.getCoverage();
                    String rhsCoverage;
                    rhsCoverage = rightObject.getCoverage();
                    String mergedCoverage = ((String) strategy.merge(LocatorUtils.property(leftLocator, "coverage", lhsCoverage), LocatorUtils.property(rightLocator, "coverage", rhsCoverage), lhsCoverage, rhsCoverage, leftObject.isSetCoverage(), rightObject.isSetCoverage()));
