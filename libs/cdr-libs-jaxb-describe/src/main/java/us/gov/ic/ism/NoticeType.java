...
import us.gov.ic.cvenum.ism.notice.CVEnumISMNoticeValues;
 ...
 * 					consist of 1 or more NoticeText&lt;/xhtml:p&gt;
 * </pre>
 * 
 * 
 ...
 *   &lt;complexContent&gt;
 *     &lt;extension base="{urn:us:gov:ic:ism}NoticeBaseType"&gt;
 *       &lt;attGroup ref="{urn:us:gov:ic:ism}NoticeAttributesOptionGroup"/&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
    ...
    implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    /**
     * Gets the value of the externalNotice property.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
    ...
    /**
     * Sets the value of the externalNotice property.
     * 
     * @param value
     *     allowed object is
     *     {@link Boolean }
     *     
     */
    public void setExternalNotice(boolean value) {
        this.externalNotice = value;
    }

    public boolean isSetExternalNotice() {
        return (this.externalNotice!= null);
    }

    public void unsetExternalNotice() {
        this.externalNotice = null;
    }
     ...
     * {@link CVEnumISMNoticeValues }
     * 
     * 
     */
    public List<CVEnumISMNoticeValues> getNoticeType() {
        if (noticeType == null) {
            noticeType = new ArrayList<CVEnumISMNoticeValues>();
        }
        return this.noticeType;
    }

    public boolean isSetNoticeType() {
        return ((this.noticeType!= null)&&(!this.noticeType.isEmpty()));
    }
    ...
    public boolean isSetNoticeReason() {
        return (this.noticeReason!= null);
    }
    ...
    public boolean isSetNoticeDate() {
        return (this.noticeDate!= null);
    }

    /**
     * Gets the value of the unregisteredNoticeType property.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of the unregisteredNoticeType property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setUnregisteredNoticeType(String value) {
        this.unregisteredNoticeType = value;
    }

    public boolean isSetUnregisteredNoticeType() {
        return (this.unregisteredNoticeType!= null);
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        {
            boolean theExternalNotice;
            theExternalNotice = (this.isSetExternalNotice()?this.getExternalNotice():false);
            strategy.appendField(locator, this, "externalNotice", buffer, theExternalNotice, this.isSetExternalNotice());
        }
        {
            List<CVEnumISMNoticeValues> theNoticeType;
            theNoticeType = (this.isSetNoticeType()?this.getNoticeType():null);
            strategy.appendField(locator, this, "noticeType", buffer, theNoticeType, this.isSetNoticeType());
        }
        {
            String theNoticeReason;
            theNoticeReason = this.getNoticeReason();
            strategy.appendField(locator, this, "noticeReason", buffer, theNoticeReason, this.isSetNoticeReason());
        }
        {
            XMLGregorianCalendar theNoticeDate;
            theNoticeDate = this.getNoticeDate();
            strategy.appendField(locator, this, "noticeDate", buffer, theNoticeDate, this.isSetNoticeDate());
        }
        {
            String theUnregisteredNoticeType;
            theUnregisteredNoticeType = this.getUnregisteredNoticeType();
            strategy.appendField(locator, this, "unregisteredNoticeType", buffer, theUnregisteredNoticeType, this.isSetUnregisteredNoticeType());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final NoticeType that = ((NoticeType) object);
        {
            boolean lhsExternalNotice;
            lhsExternalNotice = (this.isSetExternalNotice()?this.getExternalNotice():false);
            boolean rhsExternalNotice;
            rhsExternalNotice = (that.isSetExternalNotice()?that.getExternalNotice():false);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "externalNotice", lhsExternalNotice), LocatorUtils.property(thatLocator, "externalNotice", rhsExternalNotice), lhsExternalNotice, rhsExternalNotice, this.isSetExternalNotice(), that.isSetExternalNotice())) {
                return false;
            }
        }
        {
            List<CVEnumISMNoticeValues> lhsNoticeType;
            lhsNoticeType = (this.isSetNoticeType()?this.getNoticeType():null);
            List<CVEnumISMNoticeValues> rhsNoticeType;
            rhsNoticeType = (that.isSetNoticeType()?that.getNoticeType():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "noticeType", lhsNoticeType), LocatorUtils.property(thatLocator, "noticeType", rhsNoticeType), lhsNoticeType, rhsNoticeType, this.isSetNoticeType(), that.isSetNoticeType())) {
                return false;
            }
        }
        {
            String lhsNoticeReason;
            lhsNoticeReason = this.getNoticeReason();
            String rhsNoticeReason;
            rhsNoticeReason = that.getNoticeReason();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "noticeReason", lhsNoticeReason), LocatorUtils.property(thatLocator, "noticeReason", rhsNoticeReason), lhsNoticeReason, rhsNoticeReason, this.isSetNoticeReason(), that.isSetNoticeReason())) {
                return false;
            }
        }
        {
            XMLGregorianCalendar lhsNoticeDate;
            lhsNoticeDate = this.getNoticeDate();
            XMLGregorianCalendar rhsNoticeDate;
            rhsNoticeDate = that.getNoticeDate();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "noticeDate", lhsNoticeDate), LocatorUtils.property(thatLocator, "noticeDate", rhsNoticeDate), lhsNoticeDate, rhsNoticeDate, this.isSetNoticeDate(), that.isSetNoticeDate())) {
                return false;
            }
        }
        {
            String lhsUnregisteredNoticeType;
            lhsUnregisteredNoticeType = this.getUnregisteredNoticeType();
            String rhsUnregisteredNoticeType;
            rhsUnregisteredNoticeType = that.getUnregisteredNoticeType();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "unregisteredNoticeType", lhsUnregisteredNoticeType), LocatorUtils.property(thatLocator, "unregisteredNoticeType", rhsUnregisteredNoticeType), lhsUnregisteredNoticeType, rhsUnregisteredNoticeType, this.isSetUnregisteredNoticeType(), that.isSetUnregisteredNoticeType())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            boolean theExternalNotice;
            theExternalNotice = (this.isSetExternalNotice()?this.getExternalNotice():false);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "externalNotice", theExternalNotice), currentHashCode, theExternalNotice, this.isSetExternalNotice());
        }
        {
            List<CVEnumISMNoticeValues> theNoticeType;
            theNoticeType = (this.isSetNoticeType()?this.getNoticeType():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "noticeType", theNoticeType), currentHashCode, theNoticeType, this.isSetNoticeType());
        }
        {
            String theNoticeReason;
            theNoticeReason = this.getNoticeReason();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "noticeReason", theNoticeReason), currentHashCode, theNoticeReason, this.isSetNoticeReason());
        }
        {
            XMLGregorianCalendar theNoticeDate;
            theNoticeDate = this.getNoticeDate();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "noticeDate", theNoticeDate), currentHashCode, theNoticeDate, this.isSetNoticeDate());
        }
        {
            String theUnregisteredNoticeType;
            theUnregisteredNoticeType = this.getUnregisteredNoticeType();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "unregisteredNoticeType", theUnregisteredNoticeType), currentHashCode, theUnregisteredNoticeType, this.isSetUnregisteredNoticeType());
        }
        {
            CVEnumISMClassificationAll theClassification;
            theClassification = this.getClassification();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof NoticeType) {
            final NoticeType copy = ((NoticeType) draftCopy);
            {
                Boolean externalNoticeShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetExternalNotice());
                if (externalNoticeShouldBeCopiedAndSet == Boolean.TRUE) {
                    boolean sourceExternalNotice;
                    sourceExternalNotice = (this.isSetExternalNotice()?this.getExternalNotice():false);
                    boolean copyExternalNotice = strategy.copy(LocatorUtils.property(locator, "externalNotice", sourceExternalNotice), sourceExternalNotice, this.isSetExternalNotice());
                    copy.setExternalNotice(copyExternalNotice);
                } else {
                    if (externalNoticeShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.unsetExternalNotice();
                    }
                }
            }
            {
                Boolean noticeTypeShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetNoticeType());
                if (noticeTypeShouldBeCopiedAndSet == Boolean.TRUE) {
                    List<CVEnumISMNoticeValues> sourceNoticeType;
                    sourceNoticeType = (this.isSetNoticeType()?this.getNoticeType():null);
                    @SuppressWarnings("unchecked")
                    List<CVEnumISMNoticeValues> copyNoticeType = ((List<CVEnumISMNoticeValues> ) strategy.copy(LocatorUtils.property(locator, "noticeType", sourceNoticeType), sourceNoticeType, this.isSetNoticeType()));
                    copy.unsetNoticeType();
                    if (copyNoticeType!= null) {
                        List<CVEnumISMNoticeValues> uniqueNoticeTypel = copy.getNoticeType();
                        uniqueNoticeTypel.addAll(copyNoticeType);
                    }
                } else {
                    if (noticeTypeShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.unsetNoticeType();
                    }
                }
            }
            {
                Boolean noticeReasonShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetNoticeReason());
                if (noticeReasonShouldBeCopiedAndSet == Boolean.TRUE) {
                    String sourceNoticeReason;
                    sourceNoticeReason = this.getNoticeReason();
                    String copyNoticeReason = ((String) strategy.copy(LocatorUtils.property(locator, "noticeReason", sourceNoticeReason), sourceNoticeReason, this.isSetNoticeReason()));
                    copy.setNoticeReason(copyNoticeReason);
                } else {
                    if (noticeReasonShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.noticeReason = null;
                    }
                }
            }
            {
                Boolean noticeDateShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetNoticeDate());
                if (noticeDateShouldBeCopiedAndSet == Boolean.TRUE) {
                    XMLGregorianCalendar sourceNoticeDate;
                    sourceNoticeDate = this.getNoticeDate();
                    XMLGregorianCalendar copyNoticeDate = ((XMLGregorianCalendar) strategy.copy(LocatorUtils.property(locator, "noticeDate", sourceNoticeDate), sourceNoticeDate, this.isSetNoticeDate()));
                    copy.setNoticeDate(copyNoticeDate);
                } else {
                    if (noticeDateShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.noticeDate = null;
                    }
                }
            }
            {
                Boolean unregisteredNoticeTypeShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetUnregisteredNoticeType());
                if (unregisteredNoticeTypeShouldBeCopiedAndSet == Boolean.TRUE) {
                    String sourceUnregisteredNoticeType;
                    sourceUnregisteredNoticeType = this.getUnregisteredNoticeType();
                    String copyUnregisteredNoticeType = ((String) strategy.copy(LocatorUtils.property(locator, "unregisteredNoticeType", sourceUnregisteredNoticeType), sourceUnregisteredNoticeType, this.isSetUnregisteredNoticeType()));
                    copy.setUnregisteredNoticeType(copyUnregisteredNoticeType);
                } else {
                    if (unregisteredNoticeTypeShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.unregisteredNoticeType = null;
                    }
                }
            }
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        ...
        if (right instanceof NoticeType) {
            final NoticeType target = this;
            final NoticeType leftObject = ((NoticeType) left);
            final NoticeType rightObject = ((NoticeType) right);
            {
                Boolean externalNoticeShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetExternalNotice(), rightObject.isSetExternalNotice());
                if (externalNoticeShouldBeMergedAndSet == Boolean.TRUE) {
                    boolean lhsExternalNotice;
                    lhsExternalNotice = (leftObject.isSetExternalNotice()?leftObject.getExternalNotice():false);
                    boolean rhsExternalNotice;
                    rhsExternalNotice = (rightObject.isSetExternalNotice()?rightObject.getExternalNotice():false);
                    boolean mergedExternalNotice = ((boolean) strategy.merge(LocatorUtils.property(leftLocator, "externalNotice", lhsExternalNotice), LocatorUtils.property(rightLocator, "externalNotice", rhsExternalNotice), lhsExternalNotice, rhsExternalNotice, leftObject.isSetExternalNotice(), rightObject.isSetExternalNotice()));
                    target.setExternalNotice(mergedExternalNotice);
                } else {
                    if (externalNoticeShouldBeMergedAndSet == Boolean.FALSE) {
                        target.unsetExternalNotice();
                    }
                }
            }
            {
                Boolean noticeTypeShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetNoticeType(), rightObject.isSetNoticeType());
                if (noticeTypeShouldBeMergedAndSet == Boolean.TRUE) {
                    List<CVEnumISMNoticeValues> lhsNoticeType;
                    lhsNoticeType = (leftObject.isSetNoticeType()?leftObject.getNoticeType():null);
                    List<CVEnumISMNoticeValues> rhsNoticeType;
                    rhsNoticeType = (rightObject.isSetNoticeType()?rightObject.getNoticeType():null);
                    List<CVEnumISMNoticeValues> mergedNoticeType = ((List<CVEnumISMNoticeValues> ) strategy.merge(LocatorUtils.property(leftLocator, "noticeType", lhsNoticeType), LocatorUtils.property(rightLocator, "noticeType", rhsNoticeType), lhsNoticeType, rhsNoticeType, leftObject.isSetNoticeType(), rightObject.isSetNoticeType()));
                    target.unsetNoticeType();
                    if (mergedNoticeType!= null) {
                        List<CVEnumISMNoticeValues> uniqueNoticeTypel = target.getNoticeType();
                        uniqueNoticeTypel.addAll(mergedNoticeType);
                    }
                } else {
                    if (noticeTypeShouldBeMergedAndSet == Boolean.FALSE) {
                        target.unsetNoticeType();
                    }
                }
            }
            {
                Boolean noticeReasonShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetNoticeReason(), rightObject.isSetNoticeReason());
                if (noticeReasonShouldBeMergedAndSet == Boolean.TRUE) {
                    String lhsNoticeReason;
                    lhsNoticeReason = leftObject.getNoticeReason();
                    String rhsNoticeReason;
                    rhsNoticeReason = rightObject.getNoticeReason();
                    String mergedNoticeReason = ((String) strategy.merge(LocatorUtils.property(leftLocator, "noticeReason", lhsNoticeReason), LocatorUtils.property(rightLocator, "noticeReason", rhsNoticeReason), lhsNoticeReason, rhsNoticeReason, leftObject.isSetNoticeReason(), rightObject.isSetNoticeReason()));
                    target.setNoticeReason(mergedNoticeReason);
                } else {
                    if (noticeReasonShouldBeMergedAndSet == Boolean.FALSE) {
                        target.noticeReason = null;
                    }
                }
            }
            {
                Boolean noticeDateShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetNoticeDate(), rightObject.isSetNoticeDate());
                if (noticeDateShouldBeMergedAndSet == Boolean.TRUE) {
                    XMLGregorianCalendar lhsNoticeDate;
                    lhsNoticeDate = leftObject.getNoticeDate();
                    XMLGregorianCalendar rhsNoticeDate;
                    rhsNoticeDate = rightObject.getNoticeDate();
                    XMLGregorianCalendar mergedNoticeDate = ((XMLGregorianCalendar) strategy.merge(LocatorUtils.property(leftLocator, "noticeDate", lhsNoticeDate), LocatorUtils.property(rightLocator, "noticeDate", rhsNoticeDate), lhsNoticeDate, rhsNoticeDate, leftObject.isSetNoticeDate(), rightObject.isSetNoticeDate()));
                    target.setNoticeDate(mergedNoticeDate);
                } else {
                    if (noticeDateShouldBeMergedAndSet == Boolean.FALSE) {
                        target.noticeDate = null;
                    }
                }
            }
            {
                Boolean unregisteredNoticeTypeShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetUnregisteredNoticeType(), rightObject.isSetUnregisteredNoticeType());
                if (unregisteredNoticeTypeShouldBeMergedAndSet == Boolean.TRUE) {
                    String lhsUnregisteredNoticeType;
                    lhsUnregisteredNoticeType = leftObject.getUnregisteredNoticeType();
                    String rhsUnregisteredNoticeType;
                    rhsUnregisteredNoticeType = rightObject.getUnregisteredNoticeType();
                    String mergedUnregisteredNoticeType = ((String) strategy.merge(LocatorUtils.property(leftLocator, "unregisteredNoticeType", lhsUnregisteredNoticeType), LocatorUtils.property(rightLocator, "unregisteredNoticeType", rhsUnregisteredNoticeType), lhsUnregisteredNoticeType, rhsUnregisteredNoticeType, leftObject.isSetUnregisteredNoticeType(), rightObject.isSetUnregisteredNoticeType()));
                    target.setUnregisteredNoticeType(mergedUnregisteredNoticeType);
                } else {
                    if (unregisteredNoticeTypeShouldBeMergedAndSet == Boolean.FALSE) {
                        target.unregisteredNoticeType = null;
                    }
                }
            }
            {
    ...
    public void setNoticeType(List<CVEnumISMNoticeValues> value) {
        this.noticeType = null;
        if (value!= null) {
            List<CVEnumISMNoticeValues> draftl = this.getNoticeType();
            draftl.addAll(value);
        }
    }
