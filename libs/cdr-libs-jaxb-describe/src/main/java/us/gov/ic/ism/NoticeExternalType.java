 ...
 * 					consist of 1 or more NoticeText for use when the notice refers to something
 * 					external.&lt;/xhtml:p&gt;
 * </pre>
 * 
 * 
 * <p>Java class for NoticeExternalType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="NoticeExternalType"&gt;
 *   &lt;complexContent&gt;
 *     &lt;extension base="{urn:us:gov:ic:ism}NoticeBaseType"&gt;
 *       &lt;attGroup ref="{urn:us:gov:ic:ism}NoticeExternalAttributesOptionGroup"/&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
@XmlType(name = "NoticeExternalType")
public class NoticeExternalType
    extends NoticeBaseType
    implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{

    private final static long serialVersionUID = 1L;
    @XmlAttribute(name = "externalNotice", namespace = "urn:us:gov:ic:ism", required = true)
    @NotNull(message = "NoticeExternalType.externalNotice {javax.validation.constraints.NotNull.message}")
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        super.appendFields(locator, buffer, strategy);
        {
            ...
            theExternalNotice = this.isExternalNotice();
            strategy.appendField(locator, this, "externalNotice", buffer, theExternalNotice, true);
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final NoticeExternalType that = ((NoticeExternalType) object);
        {
            boolean lhsExternalNotice;
            lhsExternalNotice = this.isExternalNotice();
            boolean rhsExternalNotice;
            rhsExternalNotice = that.isExternalNotice();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "externalNotice", lhsExternalNotice), LocatorUtils.property(thatLocator, "externalNotice", rhsExternalNotice), lhsExternalNotice, rhsExternalNotice, true, true)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            boolean theExternalNotice;
            theExternalNotice = this.isExternalNotice();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "externalNotice", theExternalNotice), currentHashCode, theExternalNotice, true);
        }
        {
            List<CVEnumISMNoticeValues> theNoticeType;
            theNoticeType = (this.isSetNoticeType()?this.getNoticeType():null);
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof NoticeExternalType) {
            final NoticeExternalType copy = ((NoticeExternalType) draftCopy);
            {
                Boolean externalNoticeShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, true);
                if (externalNoticeShouldBeCopiedAndSet == Boolean.TRUE) {
                    boolean sourceExternalNotice;
                    sourceExternalNotice = this.isExternalNotice();
                    boolean copyExternalNotice = strategy.copy(LocatorUtils.property(locator, "externalNotice", sourceExternalNotice), sourceExternalNotice, true);
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        ...
        if (right instanceof NoticeExternalType) {
            final NoticeExternalType target = this;
            final NoticeExternalType leftObject = ((NoticeExternalType) left);
            final NoticeExternalType rightObject = ((NoticeExternalType) right);
            {
                Boolean externalNoticeShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, true, true);
                if (externalNoticeShouldBeMergedAndSet == Boolean.TRUE) {
                    boolean lhsExternalNotice;
                    lhsExternalNotice = leftObject.isExternalNotice();
                    boolean rhsExternalNotice;
                    rhsExternalNotice = rightObject.isExternalNotice();
                    boolean mergedExternalNotice = ((boolean) strategy.merge(LocatorUtils.property(leftLocator, "externalNotice", lhsExternalNotice), LocatorUtils.property(rightLocator, "externalNotice", rhsExternalNotice), lhsExternalNotice, rhsExternalNotice, true, true));
