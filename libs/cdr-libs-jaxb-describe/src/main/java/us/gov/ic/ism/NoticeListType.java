 ...
 * 
 * 
 * <p>Java class for NoticeListType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="NoticeListType"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:us:gov:ic:ism}Notice" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "NoticeListType", propOrder = {
    "notice"
})
public class NoticeListType implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{

    private final static long serialVersionUID = 1L;
    @XmlElement(name = "Notice", required = true)
    @NotNull(message = "NoticeListType.notice {javax.validation.constraints.NotNull.message}")
    @Size(min = 1)
    @Valid
    protected List<NoticeType> notice;
    @XmlAttribute(name = "classification", namespace = "urn:us:gov:ic:ism", required = true)
    @NotNull(message = "NoticeListType.classification {javax.validation.constraints.NotNull.message}")
    ...
    @NotNull(message = "NoticeListType.ownerProducer {javax.validation.constraints.NotNull.message}")
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            List<NoticeType> theNotice;
            theNotice = (this.isSetNotice()?this.getNotice():null);
            strategy.appendField(locator, this, "notice", buffer, theNotice, this.isSetNotice());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final NoticeListType that = ((NoticeListType) object);
        {
            List<NoticeType> lhsNotice;
            lhsNotice = (this.isSetNotice()?this.getNotice():null);
            List<NoticeType> rhsNotice;
            rhsNotice = (that.isSetNotice()?that.getNotice():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "notice", lhsNotice), LocatorUtils.property(thatLocator, "notice", rhsNotice), lhsNotice, rhsNotice, this.isSetNotice(), that.isSetNotice())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            List<NoticeType> theNotice;
            theNotice = (this.isSetNotice()?this.getNotice():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "notice", theNotice), currentHashCode, theNotice, this.isSetNotice());
        }
        {
            CVEnumISMClassificationAll theClassification;
            theClassification = this.getClassification();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof NoticeListType) {
            final NoticeListType copy = ((NoticeListType) draftCopy);
            {
                Boolean noticeShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetNotice());
                if (noticeShouldBeCopiedAndSet == Boolean.TRUE) {
                    List<NoticeType> sourceNotice;
                    sourceNotice = (this.isSetNotice()?this.getNotice():null);
                    @SuppressWarnings("unchecked")
                    List<NoticeType> copyNotice = ((List<NoticeType> ) strategy.copy(LocatorUtils.property(locator, "notice", sourceNotice), sourceNotice, this.isSetNotice()));
                    copy.unsetNotice();
                    if (copyNotice!= null) {
                        List<NoticeType> uniqueNoticel = copy.getNotice();
                        uniqueNoticel.addAll(copyNotice);
                    }
                } else {
                    if (noticeShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.unsetNotice();
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof NoticeListType) {
            final NoticeListType target = this;
            final NoticeListType leftObject = ((NoticeListType) left);
            final NoticeListType rightObject = ((NoticeListType) right);
            {
                Boolean noticeShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetNotice(), rightObject.isSetNotice());
                if (noticeShouldBeMergedAndSet == Boolean.TRUE) {
                    List<NoticeType> lhsNotice;
                    lhsNotice = (leftObject.isSetNotice()?leftObject.getNotice():null);
                    List<NoticeType> rhsNotice;
                    rhsNotice = (rightObject.isSetNotice()?rightObject.getNotice():null);
                    List<NoticeType> mergedNotice = ((List<NoticeType> ) strategy.merge(LocatorUtils.property(leftLocator, "notice", lhsNotice), LocatorUtils.property(rightLocator, "notice", rhsNotice), lhsNotice, rhsNotice, leftObject.isSetNotice(), rightObject.isSetNotice()));
                    target.unsetNotice();
                    if (mergedNotice!= null) {
                        List<NoticeType> uniqueNoticel = target.getNotice();
                        uniqueNoticel.addAll(mergedNotice);
                    }
                } else {
                    if (noticeShouldBeMergedAndSet == Boolean.FALSE) {
                        target.unsetNotice();
                    }
                }
            }
    ...
    public void setNotice(List<NoticeType> value) {
        this.notice = null;
        if (value!= null) {
            List<NoticeType> draftl = this.getNotice();
            draftl.addAll(value);
        }
    }
