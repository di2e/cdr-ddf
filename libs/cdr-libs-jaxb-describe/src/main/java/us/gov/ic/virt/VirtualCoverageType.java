 ...
 * 
 * 
 * <p>Java class for VirtualCoverageType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="VirtualCoverageType"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;attGroup ref="{urn:us:gov:ic:virt}NetworkAttributesGroup"/&gt;
 *       &lt;attGroup ref="{urn:us:gov:ic:ism}SecurityAttributesOptionGroup"/&gt;
...
@XmlType(name = "VirtualCoverageType")
public class VirtualCoverageType implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{

    private final static long serialVersionUID = 1L;
    @XmlAttribute(name = "protocol", namespace = "urn:us:gov:ic:virt")
    protected String protocol;
    @XmlAttribute(name = "address", namespace = "urn:us:gov:ic:virt")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final VirtualCoverageType that = ((VirtualCoverageType) object);
        {
            String lhsProtocol;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof VirtualCoverageType) {
            final VirtualCoverageType copy = ((VirtualCoverageType) draftCopy);
            {
            ...
            }
            {
                ...
                if (addressShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    String copyAddress = ((String) strategy.copy(LocatorUtils.property(locator, "address", sourceAddress), sourceAddress, this.isSetAddress()));
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof VirtualCoverageType) {
            final VirtualCoverageType target = this;
            final VirtualCoverageType leftObject = ((VirtualCoverageType) left);
            final VirtualCoverageType rightObject = ((VirtualCoverageType) right);
            {
            ...
            }
            {
                ...
                if (addressShouldBeMergedAndSet == Boolean.TRUE) {
                    ...
                    String mergedAddress = ((String) strategy.merge(LocatorUtils.property(leftLocator, "address", lhsAddress), LocatorUtils.property(rightLocator, "address", rhsAddress), lhsAddress, rhsAddress, leftObject.isSetAddress(), rightObject.isSetAddress()));
