...
@XmlType(name = "RequiredSimpleLinkWithSecurityType")
public class RequiredSimpleLinkWithSecurityType
    extends RequiredSimpleLinkType
    implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{

    private final static long serialVersionUID = 1L;
    @XmlAttribute(name = "classification", namespace = "urn:us:gov:ic:ism", required = true)
    @NotNull(message = "RequiredSimpleLinkWithSecurityType.classification {javax.validation.constraints.NotNull.message}")
    ...
    @NotNull(message = "RequiredSimpleLinkWithSecurityType.ownerProducer {javax.validation.constraints.NotNull.message}")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final RequiredSimpleLinkWithSecurityType that = ((RequiredSimpleLinkWithSecurityType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof RequiredSimpleLinkWithSecurityType) {
            final RequiredSimpleLinkWithSecurityType copy = ((RequiredSimpleLinkWithSecurityType) draftCopy);
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        ...
        if (right instanceof RequiredSimpleLinkWithSecurityType) {
            final RequiredSimpleLinkWithSecurityType target = this;
            final RequiredSimpleLinkWithSecurityType leftObject = ((RequiredSimpleLinkWithSecurityType) left);
            final RequiredSimpleLinkWithSecurityType rightObject = ((RequiredSimpleLinkWithSecurityType) right);
            {
