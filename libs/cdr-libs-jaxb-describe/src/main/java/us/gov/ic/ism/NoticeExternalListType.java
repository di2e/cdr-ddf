...
@XmlType(name = "NoticeExternalListType", propOrder = {
    "noticeExternal"
})
public class NoticeExternalListType implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    /**
     * Gets the value of the noticeExternal property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the noticeExternal property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getNoticeExternal().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link NoticeExternalType }
     * 
     * 
     */
    public List<NoticeExternalType> getNoticeExternal() {
        if (noticeExternal == null) {
            noticeExternal = new ArrayList<NoticeExternalType>();
        }
        return this.noticeExternal;
    }

    public boolean isSetNoticeExternal() {
        return ((this.noticeExternal!= null)&&(!this.noticeExternal.isEmpty()));
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            List<NoticeExternalType> theNoticeExternal;
            theNoticeExternal = (this.isSetNoticeExternal()?this.getNoticeExternal():null);
            strategy.appendField(locator, this, "noticeExternal", buffer, theNoticeExternal, this.isSetNoticeExternal());
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final NoticeExternalListType that = ((NoticeExternalListType) object);
        {
            List<NoticeExternalType> lhsNoticeExternal;
            lhsNoticeExternal = (this.isSetNoticeExternal()?this.getNoticeExternal():null);
            List<NoticeExternalType> rhsNoticeExternal;
            rhsNoticeExternal = (that.isSetNoticeExternal()?that.getNoticeExternal():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "noticeExternal", lhsNoticeExternal), LocatorUtils.property(thatLocator, "noticeExternal", rhsNoticeExternal), lhsNoticeExternal, rhsNoticeExternal, this.isSetNoticeExternal(), that.isSetNoticeExternal())) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            List<NoticeExternalType> theNoticeExternal;
            theNoticeExternal = (this.isSetNoticeExternal()?this.getNoticeExternal():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "noticeExternal", theNoticeExternal), currentHashCode, theNoticeExternal, this.isSetNoticeExternal());
        }
        {
            CVEnumISMClassificationAll theClassification;
            theClassification = this.getClassification();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof NoticeExternalListType) {
            final NoticeExternalListType copy = ((NoticeExternalListType) draftCopy);
            {
                Boolean noticeExternalShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, this.isSetNoticeExternal());
                if (noticeExternalShouldBeCopiedAndSet == Boolean.TRUE) {
                    List<NoticeExternalType> sourceNoticeExternal;
                    sourceNoticeExternal = (this.isSetNoticeExternal()?this.getNoticeExternal():null);
                    @SuppressWarnings("unchecked")
                    List<NoticeExternalType> copyNoticeExternal = ((List<NoticeExternalType> ) strategy.copy(LocatorUtils.property(locator, "noticeExternal", sourceNoticeExternal), sourceNoticeExternal, this.isSetNoticeExternal()));
                    copy.unsetNoticeExternal();
                    if (copyNoticeExternal!= null) {
                        List<NoticeExternalType> uniqueNoticeExternall = copy.getNoticeExternal();
                        uniqueNoticeExternall.addAll(copyNoticeExternal);
                    }
                } else {
                    if (noticeExternalShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.unsetNoticeExternal();
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof NoticeExternalListType) {
            final NoticeExternalListType target = this;
            final NoticeExternalListType leftObject = ((NoticeExternalListType) left);
            final NoticeExternalListType rightObject = ((NoticeExternalListType) right);
            {
                Boolean noticeExternalShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, leftObject.isSetNoticeExternal(), rightObject.isSetNoticeExternal());
                if (noticeExternalShouldBeMergedAndSet == Boolean.TRUE) {
                    List<NoticeExternalType> lhsNoticeExternal;
                    lhsNoticeExternal = (leftObject.isSetNoticeExternal()?leftObject.getNoticeExternal():null);
                    List<NoticeExternalType> rhsNoticeExternal;
                    rhsNoticeExternal = (rightObject.isSetNoticeExternal()?rightObject.getNoticeExternal():null);
                    List<NoticeExternalType> mergedNoticeExternal = ((List<NoticeExternalType> ) strategy.merge(LocatorUtils.property(leftLocator, "noticeExternal", lhsNoticeExternal), LocatorUtils.property(rightLocator, "noticeExternal", rhsNoticeExternal), lhsNoticeExternal, rhsNoticeExternal, leftObject.isSetNoticeExternal(), rightObject.isSetNoticeExternal()));
                    target.unsetNoticeExternal();
                    if (mergedNoticeExternal!= null) {
                        List<NoticeExternalType> uniqueNoticeExternall = target.getNoticeExternal();
                        uniqueNoticeExternall.addAll(mergedNoticeExternal);
                    }
                } else {
                    if (noticeExternalShouldBeMergedAndSet == Boolean.FALSE) {
                        target.unsetNoticeExternal();
                    }
                }
            }
    ...
    public void setNoticeExternal(List<NoticeExternalType> value) {
        this.noticeExternal = null;
        if (value!= null) {
            List<NoticeExternalType> draftl = this.getNoticeExternal();
            draftl.addAll(value);
        }
    }
