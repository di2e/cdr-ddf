...
/**
 * <p>Java class for ShortStringWithSecurityType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ShortStringWithSecurityType"&gt;
 *   &lt;simpleContent&gt;
...
@XmlType(name = "ShortStringWithSecurityType", propOrder = {
    "value"
})
public class ShortStringWithSecurityType implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    @NotNull(message = "ShortStringWithSecurityType.classification {javax.validation.constraints.NotNull.message}")
    ...
    @NotNull(message = "ShortStringWithSecurityType.ownerProducer {javax.validation.constraints.NotNull.message}")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ShortStringWithSecurityType that = ((ShortStringWithSecurityType) object);
        {
            String lhsValue;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof ShortStringWithSecurityType) {
            final ShortStringWithSecurityType copy = ((ShortStringWithSecurityType) draftCopy);
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof ShortStringWithSecurityType) {
            final ShortStringWithSecurityType target = this;
            final ShortStringWithSecurityType leftObject = ((ShortStringWithSecurityType) left);
            final ShortStringWithSecurityType rightObject = ((ShortStringWithSecurityType) right);
            {
