...
/**
 * <p>Java class for LongStringWithSecurityType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="LongStringWithSecurityType"&gt;
 *   &lt;simpleContent&gt;
 *     &lt;extension base="&lt;urn:us:gov:ic:ism&gt;LongStringType"&gt;
...
@XmlType(name = "LongStringWithSecurityType", propOrder = {
    "value"
})
@XmlSeeAlso({
    NoticeText.class
})
public class LongStringWithSecurityType implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    @NotNull(message = "LongStringWithSecurityType.classification {javax.validation.constraints.NotNull.message}")
    ...
    @NotNull(message = "LongStringWithSecurityType.ownerProducer {javax.validation.constraints.NotNull.message}")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final LongStringWithSecurityType that = ((LongStringWithSecurityType) object);
        {
            String lhsValue;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof LongStringWithSecurityType) {
            final LongStringWithSecurityType copy = ((LongStringWithSecurityType) draftCopy);
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof LongStringWithSecurityType) {
            final LongStringWithSecurityType target = this;
            final LongStringWithSecurityType leftObject = ((LongStringWithSecurityType) left);
            final LongStringWithSecurityType rightObject = ((LongStringWithSecurityType) right);
            {
